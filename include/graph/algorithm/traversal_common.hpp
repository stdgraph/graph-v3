 ...
 * 
 * This concept defines the requirements for a function that extracts weights from edges and
 * can be used with custom distance comparison and combination operations.
 * 
 * @tparam G Graph type
 ...
 * less-than comparison and addition for distance operations.
 * 
 * @tparam G Graph type
...
template <class G, class Visitor>
concept has_on_forward_or_cross_edge =
      requires(Visitor& v, const G& g, const edge_t<G>& e) {
