...
struct vertexlist_adaptor_fn {
    ...
    auto operator()() const {
        return vertexlist_adaptor_closure<void>{monostate{}};
    }
...
struct incidence_adaptor_fn {
    ...
    auto operator()(UID&& uid, EVF&& evf) const {
        return incidence_adaptor_closure<std::decay_t<UID>, std::decay_t<EVF>>{
            std::forward<UID>(uid), std::forward<EVF>(evf)};
    }
...
struct neighbors_adaptor_fn {
    ...
    auto operator()(UID&& uid, VVF&& vvf) const {
        return neighbors_adaptor_closure<std::decay_t<UID>, std::decay_t<VVF>>{
            std::forward<UID>(uid), std::forward<VVF>(vvf)};
    }
...
struct edgelist_adaptor_fn {
    ...
    auto operator()() const {
        return edgelist_adaptor_closure<void>{monostate{}};
    }
...
struct vertices_dfs_adaptor_closure {
    ...
    friend auto operator|(G&& g, vertices_dfs_adaptor_closure adaptor) {
        if constexpr (std::is_void_v<VVF>) {
            ...
            return vertices_dfs(std::forward<G>(g), std::move(adaptor.seed), std::move(adaptor.vvf), std::move(adaptor.alloc));
        }
    }
};
...
struct vertices_dfs_adaptor_fn {
    ...
    auto operator()(G&& g, Seed&& seed, VVF&& vvf, Alloc&& alloc) const {
        return graph::views::vertices_dfs(std::forward<G>(g), std::forward<Seed>(seed), std::forward<VVF>(vvf), std::forward<Alloc>(alloc));
    }
};
...
struct edges_dfs_adaptor_fn {
    ...
    auto operator()(G&& g, Seed&& seed, EVF&& evf, Alloc&& alloc) const {
        return graph::views::edges_dfs(std::forward<G>(g), std::forward<Seed>(seed), std::forward<EVF>(evf), std::forward<Alloc>(alloc));
    }
};
...
struct vertices_bfs_adaptor_closure {
    ...
    friend auto operator|(G&& g, vertices_bfs_adaptor_closure adaptor) {
        if constexpr (std::is_void_v<VVF>) {
            ...
            return vertices_bfs(std::forward<G>(g), std::move(adaptor.seed), std::move(adaptor.vvf), std::move(adaptor.alloc));
        }
    }
};
...
struct vertices_bfs_adaptor_fn {
    ...
    template<adj_list::index_adjacency_list G, class Seed, class VVF, class Alloc>
    auto operator()(G&& g, Seed&& seed, VVF&& vvf, Alloc&& alloc) const {
        return graph::views::vertices_bfs(std::forward<G>(g), std::forward<Seed>(seed), std::forward<VVF>(vvf), std::forward<Alloc>(alloc));
    }
};
...
struct edges_bfs_adaptor_fn {
    ...
    template<adj_list::index_adjacency_list G, class Seed, class EVF, class Alloc>
    auto operator()(G&& g, Seed&& seed, EVF&& evf, Alloc&& alloc) const {
        return graph::views::edges_bfs(std::forward<G>(g), std::forward<Seed>(seed), std::forward<EVF>(evf), std::forward<Alloc>(alloc));
    }
};
...
struct vertices_topological_sort_adaptor_fn {
    ...
    auto operator()() const {
        return vertices_topological_sort_adaptor_closure<void, std::allocator<bool>>{};
    }
    
    // With value function: g | vertices_topological_sort(vvf)
    template<class VVF>
    auto operator()(VVF&& vvf) const {
        return vertices_topological_sort_adaptor_closure<std::decay_t<VVF>, std::allocator<bool>>{
            std::forward<VVF>(vvf), std::allocator<bool>{}};
    }
    ...
    auto operator()(G&& g, VVF&& vvf, Alloc&& alloc) const {
        return graph::views::vertices_topological_sort(std::forward<G>(g), std::forward<VVF>(vvf), std::forward<Alloc>(alloc));
    }
};
...
struct edges_topological_sort_adaptor_fn {
    ...
    auto operator()() const {
        return edges_topological_sort_adaptor_closure<void, std::allocator<bool>>{};
    }
    
    // With value function: g | edges_topological_sort(evf)
    template<class EVF>
    auto operator()(EVF&& evf) const {
        return edges_topological_sort_adaptor_closure<std::decay_t<EVF>, std::allocator<bool>>{
            std::forward<EVF>(evf), std::allocator<bool>{}};
    }
    ...
    auto operator()(EVF&& evf, Alloc&& alloc) const {
        return edges_topological_sort_adaptor_closure<std::decay_t<EVF>, std::decay_t<Alloc>>{
            std::forward<EVF>(evf), std::forward<Alloc>(alloc)};
    }
