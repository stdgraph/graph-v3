...
public:
  ...
  [[nodiscard]] constexpr iterator begin() const noexcept { return iterator{begin_, source_}; }

  [[nodiscard]] constexpr iterator end() const noexcept { return iterator{end_, source_}; }
