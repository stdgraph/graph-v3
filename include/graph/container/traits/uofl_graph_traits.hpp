...
// Templated type alias for quick uofl_graph definition
template <class EV = void, class VV = void, class GV = void, class VId = uint32_t, bool Bidirectional = false>
using uofl_graph = dynamic_graph<EV, VV, GV, VId, Bidirectional, uofl_graph_traits<EV, VV, GV, VId, Bidirectional>>;
