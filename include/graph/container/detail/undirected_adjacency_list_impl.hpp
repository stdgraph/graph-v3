...
template <typename VV,
          ...
          typename Alloc>
typename ual_vertex_edge_list<VV, EV, GV, VId, VContainer, Alloc>::const_iterator
ual_vertex_edge_list<VV, EV, GV, VId, VContainer, Alloc>::end(const graph_type& g, vertex_id_type uid) const noexcept {
...
template <typename VV,
          ...
          typename Alloc>
typename ual_vertex_edge_list<VV, EV, GV, VId, VContainer, Alloc>::const_iterator
ual_vertex_edge_list<VV, EV, GV, VId, VContainer, Alloc>::cend(const graph_type& g, vertex_id_type uid) const noexcept {
  return const_iterator(g, uid, nullptr);
}
...
template <typename VV,
          ...
          template <typename V, typename A> class VContainer,
          typename Alloc>
ual_edge<VV, EV, GV, VId, VContainer, Alloc>::ual_edge(graph_type& g, vertex_id_type uid, vertex_id_type vid) noexcept
...
template <typename VV,
          ...
          typename Alloc>
typename ual_vertex<VV, EV, GV, VId, VContainer, Alloc>::const_vertex_edge_iterator
ual_vertex<VV, EV, GV, VId, VContainer, Alloc>::edges_cbegin(const graph_type& g, vertex_id_type uid) const noexcept {
...
base_undirected_adjacency_list<VV, EV, GV, VId, VContainer, Alloc>::try_find_vertex(vertex_id_type id) {
...
base_undirected_adjacency_list<VV, EV, GV, VId, VContainer, Alloc>::try_find_vertex(vertex_id_type id) const {
  if (id < this->vertices_.size())
    return this->vertices_.begin() + id;
  else
    return this->vertices_.end();
...
undirected_adjacency_list<VV, EV, GV, VId, VContainer, Alloc>::operator=(const undirected_adjacency_list& other) {
  if (this != &other) {
...
template <typename VV,
          ...
          typename Alloc>
constexpr bool
ual_neighbor_iterator<VV, EV, GV, VId, VContainer, Alloc>::operator==(const ual_neighbor_iterator& rhs) const noexcept {
...
undirected_adjacency_list<VV, EV, void, VId, VContainer, Alloc>::operator=(const undirected_adjacency_list& other) {
  if (this != &other) {
    undirected_adjacency_list tmp(other);
    swap(tmp);
  }
