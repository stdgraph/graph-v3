...
int main() {
  ...
  // Compile-check: create BFS edge views (results discarded)
  graph::views::edges_bfs(n, std::size_t{1});
  graph::views::edges_bfs(o, std::size_t{1});
  graph::views::edges_bfs(p, std::size_t{1});
  graph::views::edges_bfs(q, std::size_t{0});
