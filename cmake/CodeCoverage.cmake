            ...
            if(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
                ...
                if(LCOV AND GENHTML)
                    add_custom_target(coverage
                        ...
                        COMMAND ${LCOV} --directory . --capture --output-file coverage_raw.info --ignore-errors mismatch
                        COMMAND ${LCOV} --remove coverage_raw.info '/usr/*' '*/tests/*' --output-file coverage.info --ignore-errors mismatch,unused
