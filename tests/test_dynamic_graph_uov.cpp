...
using uov_void_void_void = dynamic_graph<void, void, void, uint32_t, false, uov_graph_traits<void, void, void, uint32_t, false>>;
using uov_int_void_void = dynamic_graph<int, void, void, uint32_t, false, uov_graph_traits<int, void, void, uint32_t, false>>;
using uov_void_int_void = dynamic_graph<void, int, void, uint32_t, false, uov_graph_traits<void, int, void, uint32_t, false>>;
using uov_int_int_void = dynamic_graph<int, int, void, uint32_t, false, uov_graph_traits<int, int, void, uint32_t, false>>;
using uov_void_void_int = dynamic_graph<void, void, int, uint32_t, false, uov_graph_traits<void, void, int, uint32_t, false>>;
...
using uov_str_void_void_void = dynamic_graph<void, void, void, std::string, false, uov_graph_traits<void, void, void, std::string, false>>;
using uov_str_int_void_void = dynamic_graph<int, void, void, std::string, false, uov_graph_traits<int, void, void, std::string, false>>;
using uov_str_void_int_void = dynamic_graph<void, int, void, std::string, false, uov_graph_traits<void, int, void, std::string, false>>;
using uov_str_int_int_int = dynamic_graph<int, int, int, std::string, false, uov_graph_traits<int, int, int, std::string, false>>;

using uov_sourced = dynamic_graph<void, void, void, uint32_t, true, uov_graph_traits<void, void, void, uint32_t, true>>;
using uov_int_sourced = dynamic_graph<int, void, void, uint32_t, true, uov_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("uov traits verification", "[dynamic_graph][uov][traits]") {
    ...
    SECTION("edges_type is std::vector") {
        ...
        static_assert(requires(edges_t e, typename edges_t::value_type v) { e.push_back(v); e.size(); });
        REQUIRE(true);
    }
