...
TEST_CASE("is_vertex_descriptor_view trait identifies vertex views", "[traits][vertex_view]") {
  ...
  SECTION("Identifies vertex_descriptor_view types") { STATIC_REQUIRE(is_vertex_descriptor_view_v<VDView>); }
...
TEST_CASE("is_edge_descriptor_view trait identifies edge views", "[traits][edge_view]") {
  ...
  SECTION("Identifies edge_descriptor_view types") { STATIC_REQUIRE(is_edge_descriptor_view_v<EDView>); }
...
TEST_CASE("Storage categories are mutually exclusive", "[traits][storage_category]") {
  ...
  SECTION("Random access and iterator-based are mutually exclusive") {
    STATIC_REQUIRE(is_random_access_descriptor_v<VD_Vector> != is_iterator_based_descriptor_v<VD_Vector>);
    STATIC_REQUIRE(is_random_access_descriptor_v<VD_List> != is_iterator_based_descriptor_v<VD_List>);
  }
}
...
TEST_CASE("random_access_descriptor concept", "[traits][concepts]") {
  ...
  SECTION("Accepts random access descriptors") { STATIC_REQUIRE(random_access_descriptor<VD_Vector>); }
...
TEST_CASE("iterator_based_descriptor concept", "[traits][concepts]") {
  ...
  SECTION("Accepts iterator-based descriptors") { STATIC_REQUIRE(iterator_based_descriptor<VD_List>); }
...
TEST_CASE("storage_category returns correct string", "[traits][utilities]") {
  ...
  SECTION("Returns 'unknown' for non-descriptor types") { REQUIRE(std::string(storage_category<int>()) == "unknown"); }
}
...
TEST_CASE("Traits enable generic programming with descriptors", "[traits][integration]") {
  ...
  SECTION("Can write generic code using concepts") {
    auto process_vertex = []<vertex_descriptor_type T>(const T& vd) { return vd.vertex_id(); };
