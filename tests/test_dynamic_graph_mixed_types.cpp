...
using mos_void = dynamic_graph<void, void, void, uint64_t, false,
                               mos_graph_traits<void, void, void, uint64_t, false>>;
...
TEST_CASE("Different graph types with same structure", "[6.4.1][mixed][same-structure]") {
    vov_void g1({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 0}});
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 0}});
    dofl_void g3({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 0}});
...
TEST_CASE("Generic function with string ID graph", "[6.4.1][mixed][string-ids]") {
    mos_string g({{.source_id = "A", .target_id = "B"}, {.source_id = "B", .target_id = "C"}, {.source_id = "C", .target_id = "A"}});
...
TEST_CASE("Star topology across types", "[6.4.1][mixed][star]") {
    vov_void g1({{.source_id = 0, .target_id = 1}, {.source_id = 0, .target_id = 2}, {.source_id = 0, .target_id = 3}, {.source_id = 0, .target_id = 4}});
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 0, .target_id = 2}, {.source_id = 0, .target_id = 3}, {.source_id = 0, .target_id = 4}});
    dofl_void g3({{.source_id = 0, .target_id = 1}, {.source_id = 0, .target_id = 2}, {.source_id = 0, .target_id = 3}, {.source_id = 0, .target_id = 4}});
...
TEST_CASE("Chain topology across types", "[6.4.1][mixed][chain]") {
    vov_void g1({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 4}});
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 4}});
    dofl_void g3({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 4}});
...
TEST_CASE("Complex graph with multiple components", "[6.4.1][mixed][complex]") {
    vov_void g1({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 3, .target_id = 4}, {.source_id = 4, .target_id = 5}, {.source_id = 5, .target_id = 3}});
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 3, .target_id = 4}, {.source_id = 4, .target_id = 5}, {.source_id = 5, .target_id = 3}});
...
TEST_CASE("Bidirectional edges across types", "[6.4.1][mixed][bidirectional]") {
    vov_void g1({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 0}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 1}});
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 0}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 1}});
    dofl_void g3({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 0}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 1}});
...
TEST_CASE("String ID graph with longer strings", "[6.4.1][mixed][long-strings]") {
    mos_string g({{.source_id = "Alice", .target_id = "Bob"}, {.source_id = "Bob", .target_id = "Charlie"}, {.source_id = "Charlie", .target_id = "David"}});
...
TEST_CASE("Generic function with cycle of different sizes", "[6.4.1][mixed][cycles]") {
    ...
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 0}});  // 3-cycle
    dofl_void g3({{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 3}, {.source_id = 3, .target_id = 0}});  // 4-cycle
...
TEST_CASE("All graph types with isolated vertex", "[6.4.1][mixed][isolated]") {
    vov_void g1({{.source_id = 0, .target_id = 1}, {.source_id = 2, .target_id = 3}, {.source_id = 4, .target_id = 4}});  // vertex 4 has self-loop, but conceptually could have isolated vertices
    mos_void g2({{.source_id = 0, .target_id = 1}, {.source_id = 2, .target_id = 3}});
...
TEST_CASE("vov graph constructed from range with identity projection", "[6.4.1][range-construct][identity]") {
    std::vector<copyable_edge_t<uint64_t, void>> edges = {{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 0, .target_id = 2}};
...
TEST_CASE("mos graph constructed from range with identity projection", "[6.4.1][range-construct][mos]") {
    std::vector<copyable_edge_t<uint64_t, void>> edges = {{.source_id = 10, .target_id = 20}, {.source_id = 20, .target_id = 30}};
    std::vector<uint64_t> partitions;
...
TEST_CASE("dofl graph constructed from range with identity projection", "[6.4.1][range-construct][dofl]") {
    std::vector<copyable_edge_t<uint64_t, void>> edges = {{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}, {.source_id = 2, .target_id = 0}};
    std::vector<uint64_t> partitions;
...
TEST_CASE("mixed construction methods coexist", "[6.4.1][range-construct][mixed-methods]") {
    ...
    std::vector<copyable_edge_t<uint64_t, void>> edges = {{.source_id = 0, .target_id = 1}, {.source_id = 1, .target_id = 2}};
    std::vector<uint64_t> partitions;
    mos_void g2(2ul, edges, identity{}, partitions);
    
    // Custom projection
    struct Edge { uint64_t u, v; };
