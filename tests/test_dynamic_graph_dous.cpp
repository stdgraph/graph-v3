/**
 * @file test_dynamic_graph_dous.cpp
 * @brief Comprehensive tests for dynamic_graph with deque vertices + unordered_set edges
 * 
 * Phase 4.2.2: Unordered Set Edge Container Support
 * Tests dous_graph_traits (deque vertices + unordered_set edges)
 * 
...
TEST_CASE("dous load_edges", "[dous][load]") {
    ...
    SECTION("edges with values") {
        ...
        std::deque<std::pair<uint32_t, int>> edges;
        for (auto& e : v0.edges()) {
...
// Summary: dous Tests
//
// This file tests dous_graph_traits (deque vertices + unordered_set edges).
//
...
//
// All tests pass, confirming dous_graph_traits works correctly.
//==================================================================================================
