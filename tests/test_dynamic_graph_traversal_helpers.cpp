 ...
 */
template<typename G>
bool generic_has_edge(const G& g, const typename G::vertex_id_type& uid, 
                      const typename G::vertex_id_type& vid) {
    // Find source vertex
 ...
 */
template<typename G>
std::vector<typename G::vertex_id_type> get_neighbors(const G& g, 
                                                       const typename G::vertex_id_type& uid) {
