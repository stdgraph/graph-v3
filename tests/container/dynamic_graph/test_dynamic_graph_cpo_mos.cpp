//
// test_dynamic_graph_cpo_mos.cpp - CPO tests for mos_graph_traits (map + set)
//
// This file tests CPO integration with mos_graph_traits (map vertices + set edges).
//
// Key characteristics:
...
//==================================================================================================
// Type Aliases for mos_graph_traits configurations
//==================================================================================================
...
using mos_str_int_vv = dynamic_graph<void, int, void, std::string, false,
                                     mos_graph_traits<void, int, void, std::string, false>>;
...
using mos_str_sourced = dynamic_graph<void, void, void, std::string, true,
                                      mos_graph_traits<void, void, void, std::string, true>>;

//==================================================================================================
// 1. vertices(g) CPO Tests
//==================================================================================================

TEST_CASE("mos CPO vertices(g)", "[dynamic_graph][mos][cpo][vertices]") {
    SECTION("empty graph") {
        mos_void g;
...
TEST_CASE("mos CPO num_vertices(g)", "[dynamic_graph][mos][cpo][num_vertices]") {
    SECTION("empty graph") {
        mos_void g;
...
TEST_CASE("mos CPO find_vertex(g, id)", "[dynamic_graph][mos][cpo][find_vertex]") {
...
TEST_CASE("mos CPO vertex_id(g, u)", "[dynamic_graph][mos][cpo][vertex_id]") {
...
TEST_CASE("mos CPO num_edges(g)", "[dynamic_graph][mos][cpo][num_edges]") {
    SECTION("empty graph") {
        mos_void g;
...
TEST_CASE("mos CPO edges(g, u)", "[dynamic_graph][mos][cpo][edges]") {
...
TEST_CASE("mos CPO degree(g, u)", "[dynamic_graph][mos][cpo][degree]") {
    SECTION("vertex with no edges") {
        mos_void g({{0, 1}});
...
TEST_CASE("mos CPO target_id(g, uv)", "[dynamic_graph][mos][cpo][target_id]") {
...
TEST_CASE("mos CPO target(g, uv)", "[dynamic_graph][mos][cpo][target]") {
...
TEST_CASE("mos CPO find_vertex_edge(g, u, v)", "[dynamic_graph][mos][cpo][find_vertex_edge]") {
...
TEST_CASE("mos CPO contains_edge(g, u, v)", "[dynamic_graph][mos][cpo][contains_edge]") {
...
TEST_CASE("mos CPO vertex_value(g, u)", "[dynamic_graph][mos][cpo][vertex_value]") {
...
TEST_CASE("mos CPO edge_value(g, uv)", "[dynamic_graph][mos][cpo][edge_value]") {
...
TEST_CASE("mos CPO graph_value(g)", "[dynamic_graph][mos][cpo][graph_value]") {
...
TEST_CASE("mos CPO has_edge(g)", "[dynamic_graph][mos][cpo][has_edge]") {
    SECTION("empty graph") {
        mos_void g;
...
TEST_CASE("mos CPO source_id(g, uv)", "[dynamic_graph][mos][cpo][source_id]") {
...
TEST_CASE("mos CPO source(g, uv)", "[dynamic_graph][mos][cpo][source]") {
...
TEST_CASE("mos CPO partition_id(g, u)", "[dynamic_graph][mos][cpo][partition_id]") {
...
TEST_CASE("mos CPO num_partitions(g)", "[dynamic_graph][mos][cpo][num_partitions]") {
    SECTION("default single partition") {
        mos_void g({{0, 1}, {1, 2}});
...
TEST_CASE("mos CPO vertices(g, pid)", "[dynamic_graph][mos][cpo][vertices][partition]") {
...
TEST_CASE("mos CPO num_vertices(g, pid)", "[dynamic_graph][mos][cpo][num_vertices][partition]") {
...
TEST_CASE("mos CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][mos][cpo][find_vertex_edge][uid_vid]") {
    SECTION("basic usage") {
        mos_void g({{0, 1}, {0, 2}, {1, 2}, {2, 3}});
...
TEST_CASE("mos CPO contains_edge(g, uid, vid)", "[dynamic_graph][mos][cpo][contains_edge][uid_vid]") {
    SECTION("basic usage") {
        mos_void g({{0, 1}, {0, 2}, {1, 2}, {2, 3}});
...
TEST_CASE("mos CPO integration", "[dynamic_graph][mos][cpo][integration]") {
...
TEST_CASE("mos CPO integration: values", "[dynamic_graph][mos][cpo][integration]") {
    ...
    SECTION("string IDs with values") {
        using G = dynamic_graph<int, int, void, std::string, false,
                                mos_graph_traits<int, int, void, std::string, false>>;
...
TEST_CASE("mos CPO integration: modify vertex and edge values", "[dynamic_graph][mos][cpo][integration]") {
...
TEST_CASE("mos CPO set-specific behavior", "[dynamic_graph][mos][cpo][set]") {
...
TEST_CASE("mos CPO map-specific behavior", "[dynamic_graph][mos][cpo][map]") {
