...
using dov_void_void_void = dynamic_graph<void, void, void, uint32_t, false, dov_graph_traits<void, void, void, uint32_t, false>>;
using dov_int_void_void = dynamic_graph<int, void, void, uint32_t, false, dov_graph_traits<int, void, void, uint32_t, false>>;
using dov_void_int_void = dynamic_graph<void, int, void, uint32_t, false, dov_graph_traits<void, int, void, uint32_t, false>>;
using dov_int_int_void = dynamic_graph<int, int, void, uint32_t, false, dov_graph_traits<int, int, void, uint32_t, false>>;
using dov_void_void_int = dynamic_graph<void, void, int, uint32_t, false, dov_graph_traits<void, void, int, uint32_t, false>>;
using dov_int_int_int = dynamic_graph<int, int, int, uint32_t, false, dov_graph_traits<int, int, int, uint32_t, false>>;

using dov_string_string_string = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
...
using dov_int_sourced = dynamic_graph<int, void, void, uint32_t, true, dov_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("dov vertex ID types", "[dov][vertex_id]") {
    SECTION("with uint32_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, uint32_t, false, 
                                       dov_graph_traits<void, void, void, uint32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int32_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, int32_t, false, 
                                       dov_graph_traits<void, void, void, int32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int8_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, int8_t, false, 
                                       dov_graph_traits<void, void, void, int8_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int vertex id") {
        using graph_t = dynamic_graph<void, void, void, int, false, 
                                       dov_graph_traits<void, void, void, int, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
}
...
TEST_CASE("dov load_edges", "[dynamic_graph][dov][load_edges]") {
  ...
  SECTION("with custom projection") {
    ...
    g.load_edges(ee, [](const Edge& e) -> edge_data2 {
...
TEST_CASE("dov complete workflow scenarios", "[dynamic_graph][dov][workflow]") {
  ...
  SECTION("social network simulation") {
    ...
    std::deque<edge_data> friendships = {
        {0, 1, 5}, {0, 3, 3},
        {1, 2, 4}, {1, 4, 2},
        {2, 4, 5},
        {3, 4, 3}};
  ...
  SECTION("dependency graph workflow") {
    ...
    std::deque<edge_data> dependencies = {
