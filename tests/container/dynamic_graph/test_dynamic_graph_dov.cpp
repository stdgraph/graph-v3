...
using dov_void_void_void =
      dov_graph<void, void, void>;
using dov_int_void_void =
      dov_graph<int, void, void>;
using dov_void_int_void =
      dov_graph<void, int, void>;
using dov_int_int_void =
      dov_graph<int, int, void>;
using dov_void_void_int =
      dov_graph<void, void, int>;
using dov_int_int_int = dov_graph<int, int, int>;
...
TEST_CASE("dov value types", "[dov][value_types]") {
  SECTION("with void edge value") {
    using graph_t = dov_graph<void, int, int>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void vertex value") {
    using graph_t = dov_graph<int, void, int>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void graph value") {
    using graph_t = dov_graph<int, int, void>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
  ...
  SECTION("with string edge value type") {
    using graph_t = dov_graph<std::string, void, void>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string vertex value type") {
    using graph_t = dov_graph<void, std::string, void>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string graph value type") {
    using graph_t = dov_graph<void, void, std::string>;
...
TEST_CASE("dov vertex ID types", "[dov][vertex_id]") {
  ...
  SECTION("with uint64_t vertex id") {
    using graph_t =
          dov_graph<void, void, void, uint64_t>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int32_t vertex id") {
    using graph_t = dov_graph<void, void, void, int32_t>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int8_t vertex id") {
    using graph_t = dov_graph<void, void, void, int8_t>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int vertex id") {
    using graph_t = dov_graph<void, void, void, int>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
}
...
TEST_CASE("dov load_vertices", "[dynamic_graph][dov][load_vertices]") {
  ...
  SECTION("with custom projection from struct") {
    using G2           = dov_graph<int, std::string, void>;
...
TEST_CASE("dov load_edges", "[dynamic_graph][dov][load_edges]") {
  ...
  SECTION("with custom projection") {
    using G2           = dov_graph<std::string, int, void>;
    using vertex_data2 = copyable_vertex_t<uint32_t, int>;
