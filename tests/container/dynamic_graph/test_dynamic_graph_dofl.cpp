...
using dofl_void_void_void =
      dynamic_graph<void, void, void, uint32_t, false, false, dofl_graph_traits<void, void, void, uint32_t, false>>;
using dofl_int_void_void =
      dynamic_graph<int, void, void, uint32_t, false, false, dofl_graph_traits<int, void, void, uint32_t, false>>;
using dofl_void_int_void =
      dynamic_graph<void, int, void, uint32_t, false, false, dofl_graph_traits<void, int, void, uint32_t, false>>;
using dofl_int_int_void =
      dynamic_graph<int, int, void, uint32_t, false, false, dofl_graph_traits<int, int, void, uint32_t, false>>;
using dofl_void_void_int =
      dynamic_graph<void, void, int, uint32_t, false, false, dofl_graph_traits<void, void, int, uint32_t, false>>;
using dofl_int_int_int =
      dynamic_graph<int, int, int, uint32_t, false, false, dofl_graph_traits<int, int, int, uint32_t, false>>;
...
using dofl_string_string_string =
      dynamic_graph<std::string,
                    ...
                    std::string,
                    uint32_t,
                    false, false, dofl_graph_traits<std::string, std::string, std::string, uint32_t, false>>;

using dofl_sourced =
      dynamic_graph<void, void, void, uint32_t, true, false, dofl_graph_traits<void, void, void, uint32_t, true>>;
using dofl_int_sourced =
      dynamic_graph<int, void, void, uint32_t, true, false, dofl_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("dofl construction sourced", "[dynamic_graph][dofl][construction][sourced]") {
...
TEST_CASE("dofl value_types", "[dynamic_graph][dofl][value_types]") {
  SECTION("with void edge value") {
    using graph_t = dynamic_graph<void, int, int, uint32_t, false, false, dofl_graph_traits<void, int, int, uint32_t, false>>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void vertex value") {
    using graph_t = dynamic_graph<int, void, int, uint32_t, false, false, dofl_graph_traits<int, void, int, uint32_t, false>>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void graph value") {
    using graph_t = dynamic_graph<int, int, void, uint32_t, false, false, dofl_graph_traits<int, int, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
  ...
  SECTION("with string edge value type") {
    using graph_t = dynamic_graph<std::string, void, void, uint32_t, false, false, dofl_graph_traits<std::string, void, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string vertex value type") {
    using graph_t = dynamic_graph<void, std::string, void, uint32_t, false, false, dofl_graph_traits<void, std::string, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string graph value type") {
    using graph_t = dynamic_graph<void, void, std::string, uint32_t, false, false, dofl_graph_traits<void, void, std::string, uint32_t, false>>;
...
TEST_CASE("dofl vertex_id", "[dynamic_graph][dofl][vertex_id]") {
  ...
  SECTION("with int32_t vertex id") {
    using graph_t =
          dynamic_graph<void, void, void, int32_t, false, false, dofl_graph_traits<void, void, void, int32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int8_t vertex id") {
    using graph_t = dynamic_graph<void, void, void, int8_t, false, false, dofl_graph_traits<void, void, void, int8_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int vertex id") {
    using graph_t = dynamic_graph<void, void, void, int, false, false, dofl_graph_traits<void, void, void, int, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
}
...
TEST_CASE("dofl sourced", "[dynamic_graph][dofl][sourced]") {
  ...
  SECTION("sourced=true explicit") {
    dofl_sourced g;
    using traits = dofl_graph_traits<void, void, void, uint32_t, true>;
    STATIC_REQUIRE(traits::sourced == true);
  }
...
TEST_CASE("dofl various template instantiations compile", "[dynamic_graph][dofl][compilation]") {
  ...
  [[maybe_unused]] dofl_sourced              g8;
  [[maybe_unused]] dofl_int_sourced          g9;
...
TEST_CASE("dofl construction initializer_list sourced",
          "[dynamic_graph][dofl][construction][initializer_list][sourced]") {
  SECTION("construct sourced graph with initializer list") {
    using G = dofl_sourced;
    G g({{0, 1}, {1, 2}, {2, 0}});
    REQUIRE(g.size() == 3);
...
TEST_CASE("dofl load_vertices", "[dynamic_graph][dofl][load_vertices]") {
  ...
  SECTION("custom projection - load with projection from struct") {
    using G           = dynamic_graph<int, std::string, void, uint32_t, false, false, dofl_graph_traits<int, std::string, void, uint32_t, false>>;
...
TEST_CASE("dofl load_edges", "[dynamic_graph][dofl][load_edges]") {
  ...
  SECTION("custom projection - load with projection from custom struct") {
    using G           = dynamic_graph<std::string, int, void, uint32_t, false, false, dofl_graph_traits<std::string, int, void, uint32_t, false>>;
    using vertex_data = copyable_vertex_t<uint32_t, int>;
