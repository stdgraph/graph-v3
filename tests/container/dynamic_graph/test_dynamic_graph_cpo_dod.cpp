/**
 * @file test_dynamic_graph_cpo_dod.cpp
 * @brief Phase 2 CPO tests for dynamic_graph with dod_graph_traits
 * 
 ...
 * 
 * Container: deque<vertex> + deque<edge>
 * 
 ...
 *   (provides equivalent functionality to num_edges(g, u) for dod)
 ...
 * 
 * IMPORTANT: Like vov_graph_traits (vector with random_access iterators), dod_graph_traits
...
using dod_void     = dynamic_graph<void, void, void, uint32_t, false, dod_graph_traits<void, void, void, uint32_t, false>>;
using dod_int_ev   = dynamic_graph<int, void, void, uint32_t, false, dod_graph_traits<int, void, void, uint32_t, false>>;
using dod_int_vv   = dynamic_graph<void, int, void, uint32_t, false, dod_graph_traits<void, int, void, uint32_t, false>>;
using dod_all_int  = dynamic_graph<int, int, int, uint32_t, false, dod_graph_traits<int, int, int, uint32_t, false>>;
using dod_string   = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
...
using dod_sourced_void = dynamic_graph<void, void, void, uint32_t, true, dod_graph_traits<void, void, void, uint32_t, true>>;
using dod_sourced_int  = dynamic_graph<int, void, void, uint32_t, true, dod_graph_traits<int, void, void, uint32_t, true>>;
using dod_sourced_all  = dynamic_graph<int, int, int, uint32_t, true, dod_graph_traits<int, int, int, uint32_t, true>>;

//==================================================================================================
// 1. vertices(g) CPO Tests
//==================================================================================================

TEST_CASE("dod CPO vertices(g)", "[dynamic_graph][dod][cpo][vertices]") {
...
TEST_CASE("dod CPO num_vertices(g)", "[dynamic_graph][dod][cpo][num_vertices]") {
    SECTION("empty graph") {
        dod_void g;
...
TEST_CASE("dod CPO find_vertex(g, uid)", "[dynamic_graph][dod][cpo][find_vertex]") {
...
TEST_CASE("dod CPO vertex_id(g, u)", "[dynamic_graph][dod][cpo][vertex_id]") {
...
TEST_CASE("dod CPO num_edges(g)", "[dynamic_graph][dod][cpo][num_edges]") {
    SECTION("empty graph") {
        dod_void g;
...
TEST_CASE("dod CPO num_edges(g, u)", "[dynamic_graph][dod][cpo][num_edges]") {
...
TEST_CASE("dod CPO num_edges(g, uid)", "[dynamic_graph][dod][cpo][num_edges]") {
...
TEST_CASE("dod CPO edges(g, u)", "[dynamic_graph][dod][cpo][edges]") {
...
TEST_CASE("dod CPO edges(g, uid)", "[dynamic_graph][dod][cpo][edges]") {
...
TEST_CASE("dod CPO degree(g, u)", "[dynamic_graph][dod][cpo][degree]") {
...
TEST_CASE("dod CPO target_id(g, uv)", "[dynamic_graph][dod][cpo][target_id]") {
    SECTION("basic access") {
        dod_void g({{0, 1}, {0, 2}, {1, 2}});
    ...
    SECTION("with edge values") {
        dod_int_ev g({{0, 1, 100}, {0, 2, 200}, {1, 2, 300}});
    ...
    SECTION("self-loop") {
        dod_void g({{0, 0}, {0, 1}});  // Self-loop and regular edge
    ...
    SECTION("with string edge values") {
        using dod_string_ev = dynamic_graph<std::string, void, void, uint32_t, false, 
...
TEST_CASE("dod CPO target(g, uv)", "[dynamic_graph][dod][cpo][target]") {
    SECTION("basic access") {
        dod_void g({{0, 1}, {0, 2}, {1, 2}});
...
TEST_CASE("dod CPO find_vertex_edge(g, u, v)", "[dynamic_graph][dod][cpo][find_vertex_edge]") {
    ...
    SECTION("with self-loop") {
        dod_void g({{0, 0}, {0, 1}});  // 0->0 (self-loop), 0->1
...
TEST_CASE("dod CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][dod][cpo][find_vertex_edge][uid_vid]") {
    SECTION("basic usage") {
        dod_void g({{0, 1}, {0, 2}, {1, 2}, {2, 3}});
...
TEST_CASE("dod CPO contains_edge(g, u, v)", "[dynamic_graph][dod][cpo][contains_edge]") {
    SECTION("edge exists") {
        dod_void g({{0, 1}, {0, 2}, {1, 2}});
...
TEST_CASE("dod CPO contains_edge(g, uid, vid)", "[dynamic_graph][dod][cpo][contains_edge][uid_vid]") {
    SECTION("basic usage") {
        dod_void g({{0, 1}, {0, 2}, {1, 2}, {2, 3}});
...
TEST_CASE("dod CPO integration", "[dynamic_graph][dod][cpo][integration]") {
...
TEST_CASE("dod CPO has_edge(g)", "[dynamic_graph][dod][cpo][has_edge]") {
    SECTION("empty graph") {
        dod_void g;
...
TEST_CASE("dod CPO vertex_value(g, u)", "[dynamic_graph][dod][cpo][vertex_value]") {
    SECTION("basic access") {
        dod_int_vv g;
        g.resize_vertices(3);
...
TEST_CASE("dod CPO edge_value(g, uv)", "[dynamic_graph][dod][cpo][edge_value]") {
    SECTION("basic access") {
        dod_int_ev g({{0, 1, 42}, {1, 2, 99}});
...
TEST_CASE("dod CPO integration: values", "[dynamic_graph][dod][cpo][integration]") {
...
TEST_CASE("dod CPO graph_value(g)", "[dynamic_graph][dod][cpo][graph_value]") {
    SECTION("basic access") {
        dod_all_int g({{0, 1, 1}});
...
TEST_CASE("dod CPO partition_id(g, u)", "[dynamic_graph][dod][cpo][partition_id]") {
    ...
    SECTION("with different graph types") {
        dod_int_ev g1({{0, 1, 10}, {1, 2, 20}});
        dod_all_int g2({{0, 1, 1}, {1, 2, 2}});
        dod_string g3({{0, 1, "edge"}});
...
TEST_CASE("dod CPO num_partitions(g)", "[dynamic_graph][dod][cpo][num_partitions]") {
    ...
    SECTION("const correctness") {
        const dod_void g({{0, 1}});
        
        REQUIRE(num_partitions(g) == 1);
    }

    SECTION("consistency with partition_id") {
        dod_all_int g({{0, 1, 1}, {1, 2, 2}, {2, 3, 3}});
...
TEST_CASE("dod CPO vertices(g, pid)", "[dynamic_graph][dod][cpo][vertices][partition]") {
...
TEST_CASE("dod CPO num_vertices(g, pid)", "[dynamic_graph][dod][cpo][num_vertices][partition]") {
...
TEST_CASE("dod CPO source_id(g, uv)", "[dynamic_graph][dod][cpo][source_id]") {
    SECTION("basic usage") {
        dod_sourced_void g({{0, 1}, {1, 2}, {0, 2}});
    ...
    SECTION("multiple edges from same source") {
        dod_sourced_void g({{0, 1}, {0, 2}, {0, 3}});
    ...
    SECTION("different sources") {
        dod_sourced_void g({{0, 1}, {1, 2}, {2, 3}});
    ...
    SECTION("with edge values") {
        dod_sourced_int g({{0, 1, 10}, {1, 2, 20}, {2, 0, 30}});
    ...
    SECTION("const correctness") {
        const dod_sourced_void g({{0, 1}, {1, 2}});
    ...
    SECTION("parallel edges") {
        dod_sourced_int g({{0, 1, 10}, {0, 1, 20}, {0, 1, 30}});
    ...
    SECTION("star graph") {
        dod_sourced_void g({{0, 1}, {0, 2}, {0, 3}, {0, 4}});
    ...
    SECTION("chain graph") {
        dod_sourced_void g({{0, 1}, {1, 2}, {2, 3}, {3, 4}});
    ...
    SECTION("cycle graph") {
        dod_sourced_void g({{0, 1}, {1, 2}, {2, 3}, {3, 0}});
    ...
    SECTION("with all value types") {
        dod_sourced_all g({{0, 1, 100}, {1, 2, 200}, {2, 0, 300}});
...
TEST_CASE("dod CPO source(g, uv)", "[dynamic_graph][dod][cpo][source]") {
    SECTION("basic usage") {
        dod_sourced_void g({{0, 1}, {1, 2}, {0, 2}});
    ...
    SECTION("returns valid descriptor") {
        dod_sourced_void g({{0, 1}, {1, 2}, {2, 0}});
    ...
    SECTION("with vertex values") {
        dod_sourced_all g({{0, 1, 100}, {1, 2, 200}});
    ...
    SECTION("self-loops") {
        dod_sourced_void g({{0, 0}, {1, 1}, {2, 2}});
    ...
    SECTION("accumulate values from edges") {
        dod_sourced_all g({{0, 1, 100}, {1, 2, 200}, {2, 3, 300}});
...
TEST_CASE("dod CPO integration: modify vertex and edge values", "[dynamic_graph][dod][cpo][integration]") {
    dod_all_int g({{0, 1, 1}, {1, 2, 2}});
