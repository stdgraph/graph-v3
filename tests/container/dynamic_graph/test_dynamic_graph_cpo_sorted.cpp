...
TEMPLATE_TEST_CASE("sorted CPO vertices(g)", "[dynamic_graph][cpo][vertices]",
                   vos_tag, dos_tag) {
...
TEMPLATE_TEST_CASE("sorted CPO num_vertices(g)", "[dynamic_graph][cpo][num_vertices]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_vv = typename Types::int_vv;
...
TEMPLATE_TEST_CASE("sorted CPO find_vertex(g, uid)", "[dynamic_graph][cpo][find_vertex]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO vertex_id(g, u)", "[dynamic_graph][cpo][vertex_id]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO num_edges(g)", "[dynamic_graph][cpo][num_edges]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO has_edge(g)", "[dynamic_graph][cpo][has_edge]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO num_edges(g, u)", "[dynamic_graph][cpo][num_edges]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO num_edges(g, uid)", "[dynamic_graph][cpo][num_edges]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO edges(g, u)", "[dynamic_graph][cpo][edges]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO edges(g, uid)", "[dynamic_graph][cpo][edges]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO degree(g, u)", "[dynamic_graph][cpo][degree]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO target_id(g, uv)", "[dynamic_graph][cpo][target_id]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO target(g, uv)", "[dynamic_graph][cpo][target]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][cpo][find_vertex_edge]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO find_vertex_edge(g, u, v)", "[dynamic_graph][cpo][find_vertex_edge]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO contains_edge(g, uid, vid)", "[dynamic_graph][cpo][contains_edge]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO contains_edge(g, u, v)", "[dynamic_graph][cpo][contains_edge]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO vertex_value(g, u)", "[dynamic_graph][cpo][vertex_value]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_vv = typename Types::int_vv;
    using Graph_string = typename Types::string_type;
...
TEMPLATE_TEST_CASE("sorted CPO edge_value(g, uv)", "[dynamic_graph][cpo][edge_value]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_ev = typename Types::int_ev;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("sorted CPO graph_value(g)", "[dynamic_graph][cpo][graph_value]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
    using Graph_string = typename Types::string_type;
...
TEMPLATE_TEST_CASE("sorted CPO partition_id(g, u)", "[dynamic_graph][cpo][partition_id]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO num_partitions(g)", "[dynamic_graph][cpo][num_partitions]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("sorted CPO source_id(g, uv)", "[dynamic_graph][cpo][source_id]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
...
TEMPLATE_TEST_CASE("sorted CPO source(g, uv)", "[dynamic_graph][cpo][source]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_sourced_void = typename Types::sourced_void;
    using Graph_sourced_int = typename Types::sourced_int;
...
TEMPLATE_TEST_CASE("sorted CPO integration", "[dynamic_graph][cpo][integration]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("sorted CPO integration: values", "[dynamic_graph][cpo][integration]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("sorted CPO integration: modify vertex and edge values", "[dynamic_graph][cpo][integration]",
                   vos_tag, dos_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
