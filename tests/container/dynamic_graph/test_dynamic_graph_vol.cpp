...
using vol_void_void_void =
      dynamic_graph<void, void, void, uint32_t, false, false, vol_graph_traits<void, void, void, uint32_t, false>>;
using vol_int_void_void =
      dynamic_graph<int, void, void, uint32_t, false, false, vol_graph_traits<int, void, void, uint32_t, false>>;
using vol_void_int_void =
      dynamic_graph<void, int, void, uint32_t, false, false, vol_graph_traits<void, int, void, uint32_t, false>>;
using vol_int_int_void =
      dynamic_graph<int, int, void, uint32_t, false, false, vol_graph_traits<int, int, void, uint32_t, false>>;
using vol_void_void_int =
      dynamic_graph<void, void, int, uint32_t, false, false, vol_graph_traits<void, void, int, uint32_t, false>>;
using vol_int_int_int = dynamic_graph<int, int, int, uint32_t, false, false, vol_graph_traits<int, int, int, uint32_t, false>>;
...
using vol_string_string_string =
      dynamic_graph<std::string,
                    ...
                    std::string,
                    uint32_t,
                    false, false, vol_graph_traits<std::string, std::string, std::string, uint32_t, false>>;

using vol_sourced = dynamic_graph<void, void, void, uint32_t, true, false, vol_graph_traits<void, void, void, uint32_t, true>>;
using vol_int_sourced =
      dynamic_graph<int, void, void, uint32_t, true, false, vol_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("vol value types", "[vol][value_types]") {
  SECTION("with void edge value") {
    using graph_t = dynamic_graph<void, int, int, uint32_t, false, false, vol_graph_traits<void, int, int, uint32_t, false>>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void vertex value") {
    using graph_t = dynamic_graph<int, void, int, uint32_t, false, false, vol_graph_traits<int, void, int, uint32_t, false>>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void graph value") {
    using graph_t = dynamic_graph<int, int, void, uint32_t, false, false, vol_graph_traits<int, int, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
  ...
  SECTION("with string edge value type") {
    using graph_t = dynamic_graph<std::string, void, void, uint32_t, false, false, vol_graph_traits<std::string, void, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string vertex value type") {
    using graph_t = dynamic_graph<void, std::string, void, uint32_t, false, false, vol_graph_traits<void, std::string, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string graph value type") {
    using graph_t = dynamic_graph<void, void, std::string, uint32_t, false, false, vol_graph_traits<void, void, std::string, uint32_t, false>>;
...
TEST_CASE("vol vertex ID types", "[vol][vertex_id]") {
  ...
  SECTION("with uint64_t vertex id") {
    using graph_t =
          dynamic_graph<void, void, void, uint64_t, false, false, vol_graph_traits<void, void, void, uint64_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int32_t vertex id") {
    using graph_t = dynamic_graph<void, void, void, int32_t, false, false, vol_graph_traits<void, void, void, int32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int8_t vertex id") {
    using graph_t = dynamic_graph<void, void, void, int8_t, false, false, vol_graph_traits<void, void, void, int8_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int vertex id") {
    using graph_t = dynamic_graph<void, void, void, int, false, false, vol_graph_traits<void, void, void, int, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
}
...
TEST_CASE("vol initializer_list constructor with string edge values", "[vol][construction][initializer_list]") {
...
TEST_CASE("vol initializer_list constructor with graph value (copy)", "[vol][construction][initializer_list]") {
...
TEST_CASE("vol initializer_list constructor with graph value (move)", "[vol][construction][initializer_list]") {
  using G = vol_string_string_string;
...
TEST_CASE("vol initializer_list constructor with all value types", "[vol][construction][initializer_list]") {
...
TEST_CASE("vol initializer_list constructor with sourced edges", "[vol][construction][initializer_list][sourced]") {
  using G = vol_sourced;
...
TEST_CASE("vol initializer_list complex graph patterns", "[vol][construction][initializer_list]") {
  using G = vol_int_void_void;
...
TEST_CASE("vol load_vertices", "[dynamic_graph][vol][load_vertices]") {
  ...
  SECTION("load with custom projection from struct") {
    using G2           = dynamic_graph<int, std::string, void, uint32_t, false, false, vol_graph_traits<int, std::string, void, uint32_t, false>>;
...
TEST_CASE("vol load_edges", "[dynamic_graph][vol][load_edges]") {
  ...
  SECTION("load with custom projection from struct") {
    using G3           = dynamic_graph<std::string, int, void, uint32_t, false, false, vol_graph_traits<std::string, int, void, uint32_t, false>>;
...
//
// Phase 1.1 vol_graph_traits testing approaching completion.
