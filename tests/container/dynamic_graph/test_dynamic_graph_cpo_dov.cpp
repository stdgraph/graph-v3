/**
 * @file test_dynamic_graph_cpo_dov.cpp
 * @brief Phase 2 CPO tests for dynamic_graph with dov_graph_traits
 * 
 ...
 * 
 * Container: deque<vertex> + vector<edge>
 * 
 ...
 *   (provides equivalent functionality to num_edges(g, u) for dov)
 ...
 * (forward_list with forward iterators), dov_graph_traits (vector with random_access iterators)
...
using dov_void     = dynamic_graph<void, void, void, uint32_t, false, dov_graph_traits<void, void, void, uint32_t, false>>;
using dov_int_ev   = dynamic_graph<int, void, void, uint32_t, false, dov_graph_traits<int, void, void, uint32_t, false>>;
using dov_int_vv   = dynamic_graph<void, int, void, uint32_t, false, dov_graph_traits<void, int, void, uint32_t, false>>;
using dov_all_int  = dynamic_graph<int, int, int, uint32_t, false, dov_graph_traits<int, int, int, uint32_t, false>>;
using dov_string   = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
...
using dov_sourced_void = dynamic_graph<void, void, void, uint32_t, true, dov_graph_traits<void, void, void, uint32_t, true>>;
using dov_sourced_int  = dynamic_graph<int, void, void, uint32_t, true, dov_graph_traits<int, void, void, uint32_t, true>>;
using dov_sourced_all  = dynamic_graph<int, int, int, uint32_t, true, dov_graph_traits<int, int, int, uint32_t, true>>;

//==================================================================================================
// 1. vertices(g) CPO Tests
//==================================================================================================

TEST_CASE("dov CPO vertices(g)", "[dynamic_graph][dov][cpo][vertices]") {
...
TEST_CASE("dov CPO num_vertices(g)", "[dynamic_graph][dov][cpo][num_vertices]") {
    SECTION("empty graph") {
        dov_void g;
...
TEST_CASE("dov CPO find_vertex(g, uid)", "[dynamic_graph][dov][cpo][find_vertex]") {
...
TEST_CASE("dov CPO vertex_id(g, u)", "[dynamic_graph][dov][cpo][vertex_id]") {
...
TEST_CASE("dov CPO num_edges(g)", "[dynamic_graph][dov][cpo][num_edges]") {
    SECTION("empty graph") {
        dov_void g;
...
TEST_CASE("dov CPO num_edges(g, u)", "[dynamic_graph][dov][cpo][num_edges]") {
...
TEST_CASE("dov CPO num_edges(g, uid)", "[dynamic_graph][dov][cpo][num_edges]") {
...
TEST_CASE("dov CPO edges(g, u)", "[dynamic_graph][dov][cpo][edges]") {
...
TEST_CASE("dov CPO edges(g, uid)", "[dynamic_graph][dov][cpo][edges]") {
...
TEST_CASE("dov CPO degree(g, u)", "[dynamic_graph][dov][cpo][degree]") {
...
TEST_CASE("dov CPO target_id(g, uv)", "[dynamic_graph][dov][cpo][target_id]") {
    SECTION("basic access") {
        dov_void g({{0, 1}, {0, 2}, {1, 2}});
    ...
    SECTION("with edge values") {
        dov_int_ev g({{0, 1, 100}, {0, 2, 200}, {1, 2, 300}});
    ...
    SECTION("self-loop") {
        dov_void g({{0, 0}, {0, 1}});  // Self-loop and regular edge
    ...
    SECTION("with string edge values") {
        using dov_string_ev = dynamic_graph<std::string, void, void, uint32_t, false, 
...
TEST_CASE("dov CPO target(g, uv)", "[dynamic_graph][dov][cpo][target]") {
    SECTION("basic access") {
        dov_void g({{0, 1}, {0, 2}, {1, 2}});
...
TEST_CASE("dov CPO find_vertex_edge(g, u, v)", "[dynamic_graph][dov][cpo][find_vertex_edge]") {
    ...
    SECTION("with self-loop") {
        dov_void g({{0, 0}, {0, 1}});  // 0->0 (self-loop), 0->1
...
TEST_CASE("dov CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][dov][cpo][find_vertex_edge][uid_vid]") {
    SECTION("basic usage") {
        dov_void g({{0, 1}, {0, 2}, {1, 2}, {2, 3}});
...
TEST_CASE("dov CPO contains_edge(g, u, v)", "[dynamic_graph][dov][cpo][contains_edge]") {
    SECTION("edge exists") {
        dov_void g({{0, 1}, {0, 2}, {1, 2}});
...
TEST_CASE("dov CPO contains_edge(g, uid, vid)", "[dynamic_graph][dov][cpo][contains_edge][uid_vid]") {
    SECTION("basic usage") {
        dov_void g({{0, 1}, {0, 2}, {1, 2}, {2, 3}});
...
TEST_CASE("dov CPO integration", "[dynamic_graph][dov][cpo][integration]") {
...
TEST_CASE("dov CPO has_edge(g)", "[dynamic_graph][dov][cpo][has_edge]") {
    SECTION("empty graph") {
        dov_void g;
...
TEST_CASE("dov CPO vertex_value(g, u)", "[dynamic_graph][dov][cpo][vertex_value]") {
    SECTION("basic access") {
        dov_int_vv g;
        g.resize_vertices(3);
...
TEST_CASE("dov CPO edge_value(g, uv)", "[dynamic_graph][dov][cpo][edge_value]") {
    SECTION("basic access") {
        dov_int_ev g({{0, 1, 42}, {1, 2, 99}});
...
TEST_CASE("dov CPO integration: values", "[dynamic_graph][dov][cpo][integration]") {
...
TEST_CASE("dov CPO graph_value(g)", "[dynamic_graph][dov][cpo][graph_value]") {
    SECTION("basic access") {
        dov_all_int g({{0, 1, 1}});
...
TEST_CASE("dov CPO partition_id(g, u)", "[dynamic_graph][dov][cpo][partition_id]") {
    ...
    SECTION("with different graph types") {
        dov_int_ev g1({{0, 1, 10}, {1, 2, 20}});
        dov_all_int g2({{0, 1, 1}, {1, 2, 2}});
        dov_string g3({{0, 1, "edge"}});
...
TEST_CASE("dov CPO num_partitions(g)", "[dynamic_graph][dov][cpo][num_partitions]") {
    ...
    SECTION("const correctness") {
        const dov_void g({{0, 1}});
        
        REQUIRE(num_partitions(g) == 1);
    }

    SECTION("consistency with partition_id") {
        dov_all_int g({{0, 1, 1}, {1, 2, 2}, {2, 3, 3}});
...
TEST_CASE("dov CPO vertices(g, pid)", "[dynamic_graph][dov][cpo][vertices][partition]") {
...
TEST_CASE("dov CPO num_vertices(g, pid)", "[dynamic_graph][dov][cpo][num_vertices][partition]") {
...
TEST_CASE("dov CPO source_id(g, uv)", "[dynamic_graph][dov][cpo][source_id]") {
    SECTION("basic usage") {
        dov_sourced_void g({{0, 1}, {1, 2}, {0, 2}});
    ...
    SECTION("multiple edges from same source") {
        dov_sourced_void g({{0, 1}, {0, 2}, {0, 3}});
    ...
    SECTION("different sources") {
        dov_sourced_void g({{0, 1}, {1, 2}, {2, 3}});
    ...
    SECTION("with edge values") {
        dov_sourced_int g({{0, 1, 10}, {1, 2, 20}, {2, 0, 30}});
    ...
    SECTION("const correctness") {
        const dov_sourced_void g({{0, 1}, {1, 2}});
    ...
    SECTION("parallel edges") {
        dov_sourced_int g({{0, 1, 10}, {0, 1, 20}, {0, 1, 30}});
    ...
    SECTION("star graph") {
        dov_sourced_void g({{0, 1}, {0, 2}, {0, 3}, {0, 4}});
    ...
    SECTION("chain graph") {
        dov_sourced_void g({{0, 1}, {1, 2}, {2, 3}, {3, 4}});
    ...
    SECTION("cycle graph") {
        dov_sourced_void g({{0, 1}, {1, 2}, {2, 3}, {3, 0}});
    ...
    SECTION("with all value types") {
        dov_sourced_all g({{0, 1, 100}, {1, 2, 200}, {2, 0, 300}});
...
TEST_CASE("dov CPO source(g, uv)", "[dynamic_graph][dov][cpo][source]") {
    SECTION("basic usage") {
        dov_sourced_void g({{0, 1}, {1, 2}, {0, 2}});
    ...
    SECTION("returns valid descriptor") {
        dov_sourced_void g({{0, 1}, {1, 2}, {2, 0}});
    ...
    SECTION("with vertex values") {
        dov_sourced_all g({{0, 1, 100}, {1, 2, 200}});
    ...
    SECTION("self-loops") {
        dov_sourced_void g({{0, 0}, {1, 1}, {2, 2}});
    ...
    SECTION("accumulate values from edges") {
        dov_sourced_all g({{0, 1, 100}, {1, 2, 200}, {2, 3, 300}});
...
TEST_CASE("dov CPO integration: modify vertex and edge values", "[dynamic_graph][dov][cpo][integration]") {
    dov_all_int g({{0, 1, 1}, {1, 2, 2}});
