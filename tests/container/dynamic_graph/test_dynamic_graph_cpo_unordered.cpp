...
TEMPLATE_TEST_CASE("unordered CPO num_edges(g, uid)", "[dynamic_graph][cpo][num_edges]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO find_vertex_edge(g, u, v)", "[dynamic_graph][cpo][find_vertex_edge]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO contains_edge(g, uid, vid)", "[dynamic_graph][cpo][contains_edge]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO integration", "[dynamic_graph][cpo][integration]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO integration: values", "[dynamic_graph][cpo][integration]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("unordered CPO integration: modify vertex and edge values", "[dynamic_graph][cpo][integration]",
                   vous_tag, dous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
