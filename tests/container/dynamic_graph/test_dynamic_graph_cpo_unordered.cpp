 ...
 * than positional assertions. Also, unordered_set deduplicates edges by target_id.
 */
...
TEMPLATE_TEST_CASE("unordered CPO vertices(g)", "[dynamic_graph][cpo][vertices]", vous_tag, dous_tag) {
...
TEMPLATE_TEST_CASE("unordered CPO num_vertices(g)", "[dynamic_graph][cpo][num_vertices]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_vv = typename Types::int_vv;
...
TEMPLATE_TEST_CASE("unordered CPO find_vertex(g, uid)", "[dynamic_graph][cpo][find_vertex]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO vertex_id(g, u)", "[dynamic_graph][cpo][vertex_id]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO num_edges(g)", "[dynamic_graph][cpo][num_edges]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO has_edges(g)", "[dynamic_graph][cpo][has_edges]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO num_edges(g, u)", "[dynamic_graph][cpo][num_edges]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO num_edges(g, uid)", "[dynamic_graph][cpo][num_edges]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO edges(g, u)", "[dynamic_graph][cpo][edges]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO degree(g, u)", "[dynamic_graph][cpo][degree]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO target_id(g, uv)", "[dynamic_graph][cpo][target_id]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
  ...
  SECTION("basic access") {
    ...
    // Unordered: collect all targets and verify
    std::vector<uint32_t> targets;
  ...
  SECTION("self-loop") {
    ...
    // Unordered: collect and sort targets
    std::vector<uint32_t> targets;
    for (auto uv : edge_view) {
      targets.push_back(target_id(g, uv));
    }
  ...
  SECTION("iteration order") {
    ...
    // Unordered: collect and sort for comparison (order unspecified)
    std::vector<uint32_t> targets;
    for (auto uv : edge_view) {
      targets.push_back(target_id(g, uv));
    }
...
TEMPLATE_TEST_CASE("unordered CPO target(g, uv)", "[dynamic_graph][cpo][target]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
  using Graph_int_vv = typename Types::int_vv;
  ...
  SECTION("basic access") {
    ...
    // Unordered: collect targets and verify
    std::vector<uint32_t> targets;
    for (auto uv : edge_view) {
  ...
  SECTION("self-loop") {
    ...
    std::ranges::sort(targets);
    REQUIRE(targets.size() == 2);
    REQUIRE(targets[0] == 0); // Self-loop target
    REQUIRE(targets[1] == 1);
  }
...
TEMPLATE_TEST_CASE("unordered CPO find_vertex_edge(g, uid, vid)",
...
TEMPLATE_TEST_CASE("unordered CPO find_vertex_edge(g, u, v)",
                   "[dynamic_graph][cpo][find_vertex_edge]",
                   vous_tag,
                   dous_tag) {
  using Types        = graph_test_types<TestType>;
...
TEMPLATE_TEST_CASE("unordered CPO contains_edge(g, uid, vid)",
...
TEMPLATE_TEST_CASE("unordered CPO contains_edge(g, u, v)", "[dynamic_graph][cpo][contains_edge]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO vertex_value(g, u)", "[dynamic_graph][cpo][vertex_value]", vous_tag, dous_tag) {
  using Types         = graph_test_types<TestType>;
  using Graph_int_vv  = typename Types::int_vv;
  using Graph_string  = typename Types::string_type;
...
TEMPLATE_TEST_CASE("unordered CPO edge_value(g, uv)", "[dynamic_graph][cpo][edge_value]", vous_tag, dous_tag) {
  using Types         = graph_test_types<TestType>;
  using Graph_int_ev  = typename Types::int_ev;
  using Graph_all_int = typename Types::all_int;
  using Graph_string  = typename Types::string_type;
  ...
  SECTION("large graph") {
    ...
    auto u0 = *find_vertex(g, 0);
    // Unordered: collect all values and verify sum
    int    sum   = 0;
    size_t count = 0;
    for (auto uv : edges(g, u0)) {
      sum += edge_value(g, uv);
    ...
    // Sum of 10+20+...+990 = 10*(1+2+...+99) = 10*99*100/2 = 49500
    REQUIRE(count == 99);
    REQUIRE(sum == 49500);
  }
...
TEMPLATE_TEST_CASE("unordered CPO graph_value(g)", "[dynamic_graph][cpo][graph_value]", vous_tag, dous_tag) {
  using Types         = graph_test_types<TestType>;
  using Graph_all_int = typename Types::all_int;
  using Graph_string  = typename Types::string_type;
...
TEMPLATE_TEST_CASE("unordered CPO partition_id(g, u)", "[dynamic_graph][cpo][partition_id]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO num_partitions(g)", "[dynamic_graph][cpo][num_partitions]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition]", vous_tag, dous_tag) {
  using Types        = graph_test_types<TestType>;
  using Graph_void   = typename Types::void_type;
  using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered CPO num_vertices(g, pid)",
...
TEMPLATE_TEST_CASE("unordered CPO integration", "[dynamic_graph][cpo][integration]", vous_tag, dous_tag) {
  using Types      = graph_test_types<TestType>;
  using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("unordered CPO integration: values", "[dynamic_graph][cpo][integration]", vous_tag, dous_tag) {
  using Types         = graph_test_types<TestType>;
  using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("unordered CPO integration: modify vertex and edge values",
