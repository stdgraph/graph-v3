...
using uol_void_void_void =
      uol_graph<void, void, void>;
using uol_int_void_void =
      uol_graph<int, void, void>;
using uol_void_int_void =
      uol_graph<void, int, void>;
using uol_int_int_void =
      uol_graph<int, int, void>;
using uol_void_void_int =
      uol_graph<void, void, int>;
using uol_int_int_int = uol_graph<int, int, int>;

// Type aliases with string vertex IDs (a common use case for unordered_map containers)
using uol_str_void_void_void =
      uol_graph<void, void, void, std::string>;
using uol_str_int_void_void =
      uol_graph<int, void, void, std::string>;
using uol_str_void_int_void =
      uol_graph<void, int, void, std::string>;
using uol_str_int_int_int =
      uol_graph<int, int, int, std::string>;
