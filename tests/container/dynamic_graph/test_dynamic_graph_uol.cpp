...
using uol_void_void_void =
      dynamic_graph<void, void, void, uint32_t, false, uol_graph_traits<void, void, void, uint32_t, false>>;
using uol_int_void_void =
      dynamic_graph<int, void, void, uint32_t, false, uol_graph_traits<int, void, void, uint32_t, false>>;
using uol_void_int_void =
      dynamic_graph<void, int, void, uint32_t, false, uol_graph_traits<void, int, void, uint32_t, false>>;
using uol_int_int_void =
      dynamic_graph<int, int, void, uint32_t, false, uol_graph_traits<int, int, void, uint32_t, false>>;
using uol_void_void_int =
      dynamic_graph<void, void, int, uint32_t, false, uol_graph_traits<void, void, int, uint32_t, false>>;
...
using uol_str_void_void_void =
      dynamic_graph<void, void, void, std::string, false, uol_graph_traits<void, void, void, std::string, false>>;
using uol_str_int_void_void =
      dynamic_graph<int, void, void, std::string, false, uol_graph_traits<int, void, void, std::string, false>>;
using uol_str_void_int_void =
      dynamic_graph<void, int, void, std::string, false, uol_graph_traits<void, int, void, std::string, false>>;
