 ...
 * @brief Comprehensive tests for dynamic_graph with deque vertices + list edges
 * 
...
using dol_void_void_void =
      dynamic_graph<void, void, void, uint32_t, false, false, dol_graph_traits<void, void, void, uint32_t, false>>;
using dol_int_void_void =
      dynamic_graph<int, void, void, uint32_t, false, false, dol_graph_traits<int, void, void, uint32_t, false>>;
using dol_void_int_void =
      dynamic_graph<void, int, void, uint32_t, false, false, dol_graph_traits<void, int, void, uint32_t, false>>;
using dol_int_int_void =
      dynamic_graph<int, int, void, uint32_t, false, false, dol_graph_traits<int, int, void, uint32_t, false>>;
using dol_void_void_int =
      dynamic_graph<void, void, int, uint32_t, false, false, dol_graph_traits<void, void, int, uint32_t, false>>;
using dol_int_int_int = dynamic_graph<int, int, int, uint32_t, false, false, dol_graph_traits<int, int, int, uint32_t, false>>;
...
using dol_string_string_string =
      dynamic_graph<std::string,
                    ...
                    std::string,
                    uint32_t,
                    false, false, dol_graph_traits<std::string, std::string, std::string, uint32_t, false>>;

using dol_sourced = dynamic_graph<void, void, void, uint32_t, true, false, dol_graph_traits<void, void, void, uint32_t, true>>;
using dol_int_sourced =
      dynamic_graph<int, void, void, uint32_t, true, false, dol_graph_traits<int, void, void, uint32_t, true>>;

//==================================================================================================
// 1. Construction Tests
//==================================================================================================

TEST_CASE("dol default construction", "[dol][construction]") {
  SECTION("creates empty graph") {
    dol_void_void_void g;
    REQUIRE(g.size() == 0);
  }
  ...
  SECTION("with string values") {
    dol_string_string_string g;
    REQUIRE(g.size() == 0);
  }
}

TEST_CASE("dol constructor with graph value", "[dol][construction]") {
  ...
  SECTION("int GV") {
    dol_void_void_int g(42);
    REQUIRE(g.size() == 0);
    REQUIRE(g.graph_value() == 42);
  }

  SECTION("string GV") {
    dol_string_string_string g(std::string("test"));
    REQUIRE(g.size() == 0);
    REQUIRE(g.graph_value() == "test");
  }
}

TEST_CASE("dol copy and move construction", "[dol][construction]") {
  SECTION("copy constructor") {
    dol_int_int_int g1;
    dol_int_int_int g2(g1);
    REQUIRE(g2.size() == g1.size());
  }

  SECTION("move constructor") {
    dol_int_int_int g1;
    dol_int_int_int g2(std::move(g1));
    REQUIRE(g2.size() == 0);
  }

  SECTION("copy assignment") {
    dol_int_int_int g1, g2;
    g2 = g1;
    REQUIRE(g2.size() == g1.size());
  }
...
TEST_CASE("dol sourced construction", "[dol][construction][sourced]") {
...
TEST_CASE("dol basic properties", "[dol][properties]") {
...
TEST_CASE("dol graph_value()", "[dol][graph_value]") {
  SECTION("with int GV") {
    dol_void_void_int g(100);
  ...
  SECTION("const correctness") {
    const dol_void_void_int g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with string GV") {
    dol_string_string_string g(std::string("initial"));
  ...
  SECTION("with copy") {
    dol_void_void_int g1(42);
    dol_void_void_int g2 = g1;
...
TEST_CASE("dol iterators", "[dol][iterator]") {
...
TEST_CASE("dol_graph_traits", "[dol][traits]") {
  SECTION("types") {
    using traits = dol_graph_traits<int, std::string, void, uint32_t, false>;
  ...
  SECTION("sourced = true") {
    using traits = dol_graph_traits<int, std::string, void, uint32_t, true>;
    STATIC_REQUIRE(traits::sourced == true);
  }

  SECTION("vertex_id_type variations") {
    using traits_u64 = dol_graph_traits<void, void, void, uint64_t, false>;
    using traits_i32 = dol_graph_traits<void, void, void, int32_t, false>;
    using traits_i8  = dol_graph_traits<void, void, void, int8_t, false>;
  ...
  SECTION("vertices_type is deque") {
    using traits     = dol_graph_traits<void, void, void, uint32_t, false>;
...
TEST_CASE("dol empty graph edge cases", "[dol][edge_cases]") {
  SECTION("multiple empty graphs independent") {
    dol_void_void_void g1, g2, g3;
    REQUIRE(g1.size() == 0);
    REQUIRE(g2.size() == 0);
    REQUIRE(g3.size() == 0);
  }
...
TEST_CASE("dol value types", "[dol][value_types]") {
  SECTION("with void edge value") {
    using graph_t = dynamic_graph<void, int, int, uint32_t, false, false, dol_graph_traits<void, int, int, uint32_t, false>>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void vertex value") {
    using graph_t = dynamic_graph<int, void, int, uint32_t, false, false, dol_graph_traits<int, void, int, uint32_t, false>>;
    graph_t g(100);
    REQUIRE(g.graph_value() == 100);
  }

  SECTION("with void graph value") {
    using graph_t = dynamic_graph<int, int, void, uint32_t, false, false, dol_graph_traits<int, int, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
  ...
  SECTION("with all int values") {
    dol_int_int_int g(42);
    REQUIRE(g.graph_value() == 42);
  }

  SECTION("with string edge value type") {
    using graph_t = dynamic_graph<std::string, void, void, uint32_t, false, false, dol_graph_traits<std::string, void, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string vertex value type") {
    using graph_t = dynamic_graph<void, std::string, void, uint32_t, false, false, dol_graph_traits<void, std::string, void, uint32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with string graph value type") {
    using graph_t = dynamic_graph<void, void, std::string, uint32_t, false, false, dol_graph_traits<void, void, std::string, uint32_t, false>>;
    graph_t g(std::string("test"));
    REQUIRE(g.graph_value() == "test");
  }

  SECTION("with all string values") {
    dol_string_string_string g(std::string("graph"));
...
TEST_CASE("dol vertex ID types", "[dol][vertex_id]") {
  ...
  SECTION("with uint64_t vertex id") {
    using graph_t =
          dynamic_graph<void, void, void, uint64_t, false, false, dol_graph_traits<void, void, void, uint64_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int32_t vertex id") {
    using graph_t = dynamic_graph<void, void, void, int32_t, false, false, dol_graph_traits<void, void, void, int32_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int8_t vertex id") {
    using graph_t = dynamic_graph<void, void, void, int8_t, false, false, dol_graph_traits<void, void, void, int8_t, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }

  SECTION("with int vertex id") {
    using graph_t = dynamic_graph<void, void, void, int, false, false, dol_graph_traits<void, void, void, int, false>>;
    graph_t g;
    REQUIRE(g.size() == 0);
  }
}
...
TEST_CASE("dol sourced edges", "[dol][sourced]") {
  ...
  SECTION("sourced=true explicit") {
    dol_sourced g;
    using traits = dol_graph_traits<void, void, void, uint32_t, true>;
    STATIC_REQUIRE(traits::sourced == true);
  }
...
TEST_CASE("dol const correctness", "[dol][const]") {
...
TEST_CASE("dol memory and resources", "[dol][memory]") {
  SECTION("multiple graphs do not interfere") {
    dol_int_int_int g1(100);
    dol_int_int_int g2(200);
    dol_int_int_int g3(300);
...
TEST_CASE("dol various template instantiations compile", "[dol][compilation]") {
  // Just test that these types compile
  [[maybe_unused]] dol_void_void_void       g1;
  [[maybe_unused]] dol_int_void_void        g2;
  [[maybe_unused]] dol_void_int_void        g3;
  [[maybe_unused]] dol_int_int_void         g4;
  [[maybe_unused]] dol_void_void_int        g5;
  [[maybe_unused]] dol_int_int_int          g6;
  [[maybe_unused]] dol_string_string_string g7;
  [[maybe_unused]] dol_sourced              g8;
  [[maybe_unused]] dol_int_sourced          g9;
...
static_assert(std::ranges::bidirectional_range<dol_void_void_void::vertex_type::edges_type>);

//==================================================================================================
// Initializer List Constructor Tests
//==================================================================================================

TEST_CASE("dol initializer_list constructor with void edge values", "[dol][construction][initializer_list]") {
  using G = dol_void_void_void;
...
TEST_CASE("dol initializer_list constructor with int edge values", "[dol][construction][initializer_list]") {
  using G = dol_int_void_void;
...
TEST_CASE("dol initializer_list constructor with string edge values", "[dol][construction][initializer_list]") {
  using G = dol_string_string_string;
...
TEST_CASE("dol initializer_list constructor with graph value (copy)", "[dol][construction][initializer_list]") {
  using G = dol_void_void_int;
...
TEST_CASE("dol initializer_list constructor with graph value (move)", "[dol][construction][initializer_list]") {
  using G = dol_string_string_string;
...
TEST_CASE("dol initializer_list constructor with all value types", "[dol][construction][initializer_list]") {
  using G = dol_int_int_int;
...
TEST_CASE("dol initializer_list constructor with sourced edges", "[dol][construction][initializer_list][sourced]") {
  using G = dol_sourced;
...
TEST_CASE("dol initializer_list complex graph patterns", "[dol][construction][initializer_list]") {
  using G = dol_int_void_void;
...
TEST_CASE("dol load_vertices", "[dynamic_graph][dol][load_vertices]") {
  using G           = dol_int_int_void;
  ...
  SECTION("load with custom projection from struct") {
    using G2           = dynamic_graph<int, std::string, void, uint32_t, false, false, dol_graph_traits<int, std::string, void, uint32_t, false>>;
...
TEST_CASE("dol load_edges", "[dynamic_graph][dol][load_edges]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  ...
  SECTION("load with custom projection from struct") {
    using G3           = dynamic_graph<std::string, int, void, uint32_t, false, false, dol_graph_traits<std::string, int, void, uint32_t, false>>;
    ...
    G3                       g;
    std::deque<vertex_data3> vv = {{0, 1}, {1, 2}, {2, 3}};
    g.load_vertices(vv, std::identity{});
...
TEST_CASE("dol vertex access in populated graph", "[dynamic_graph][dol][vertex_access]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol edge iteration patterns", "[dynamic_graph][dol][edge_access]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol graph with complex structure", "[dynamic_graph][dol][complex]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol graph with string values", "[dynamic_graph][dol][string_values]") {
  using G           = dol_string_string_string;
...
TEST_CASE("dol single vertex graphs", "[dynamic_graph][dol][single_vertex]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol large populated graph", "[dynamic_graph][dol][large]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol mixed access patterns", "[dynamic_graph][dol][mixed]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol error handling for out-of-range access", "[dynamic_graph][dol][error]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol edge cases with empty containers", "[dynamic_graph][dol][edge_case]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol boundary value tests", "[dynamic_graph][dol][boundary]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol incremental graph building", "[dynamic_graph][dol][incremental]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol duplicate and redundant edges", "[dynamic_graph][dol][duplicates]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol graph properties and queries", "[dynamic_graph][dol][properties]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol special graph patterns", "[dynamic_graph][dol][patterns]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
//
// Phase 1.1 dol_graph_traits testing approaching completion.
...
TEST_CASE("dol iterator stability", "[dynamic_graph][dol][iterators]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol std::ranges integration", "[dynamic_graph][dol][ranges]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
...
TEST_CASE("dol algorithm compatibility", "[dynamic_graph][dol][algorithms]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
...
TEST_CASE("dol performance characteristics", "[dynamic_graph][dol][performance]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
TEST_CASE("dol complete workflow scenarios", "[dynamic_graph][dol][workflow]") {
  using G           = dol_int_int_void;
  using vertex_data = copyable_vertex_t<uint32_t, int>;
  using edge_data   = copyable_edge_t<uint32_t, int>;
...
// (845 existing tests + ~155 new dynamic_graph dol tests)
//
// Phase 1.1 dol_graph_traits testing: COMPLETE ✓
//
// Coverage achieved:
...
//
// Next phases:
// - Phase 1.5: dol_graph_traits (deque + list)
// - Phase 1.3: vov_graph_traits (deque + deque)
