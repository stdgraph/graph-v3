...
using dol_int_sourced =
      dynamic_graph<int, void, void, uint32_t, true, dol_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("dol load_vertices", "[dynamic_graph][dol][load_vertices]") {
  ...
  SECTION("load with custom projection from struct") {
    using G2           = dynamic_graph<int, std::string, void, uint32_t, false,
                                       dol_graph_traits<int, std::string, void, uint32_t, false>>;
...
TEST_CASE("dol load_edges", "[dynamic_graph][dol][load_edges]") {
  ...
  SECTION("load with custom projection from struct") {
    using G3           = dynamic_graph<std::string, int, void, uint32_t, false,
                                       dol_graph_traits<std::string, int, void, uint32_t, false>>;
