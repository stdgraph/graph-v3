...
using dol_void_void_void = dynamic_graph<void, void, void, uint32_t, false, dol_graph_traits<void, void, void, uint32_t, false>>;
using dol_int_void_void = dynamic_graph<int, void, void, uint32_t, false, dol_graph_traits<int, void, void, uint32_t, false>>;
using dol_void_int_void = dynamic_graph<void, int, void, uint32_t, false, dol_graph_traits<void, int, void, uint32_t, false>>;
using dol_int_int_void = dynamic_graph<int, int, void, uint32_t, false, dol_graph_traits<int, int, void, uint32_t, false>>;
using dol_void_void_int = dynamic_graph<void, void, int, uint32_t, false, dol_graph_traits<void, void, int, uint32_t, false>>;
using dol_int_int_int = dynamic_graph<int, int, int, uint32_t, false, dol_graph_traits<int, int, int, uint32_t, false>>;

using dol_string_string_string = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
                                                  dol_graph_traits<std::string, std::string, std::string, uint32_t, false>>;

using dol_sourced = dynamic_graph<void, void, void, uint32_t, true, dol_graph_traits<void, void, void, uint32_t, true>>;
using dol_int_sourced = dynamic_graph<int, void, void, uint32_t, true, dol_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("dol value types", "[dol][value_types]") {
    ...
    SECTION("with string edge value type") {
        using graph_t = dynamic_graph<std::string, void, void, uint32_t, false, 
                                       dol_graph_traits<std::string, void, void, uint32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with string vertex value type") {
        using graph_t = dynamic_graph<void, std::string, void, uint32_t, false, 
                                       dol_graph_traits<void, std::string, void, uint32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with string graph value type") {
        using graph_t = dynamic_graph<void, void, std::string, uint32_t, false, 
                                       dol_graph_traits<void, void, std::string, uint32_t, false>>;
...
TEST_CASE("dol vertex ID types", "[dol][vertex_id]") {
    SECTION("with uint32_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, uint32_t, false, 
                                       dol_graph_traits<void, void, void, uint32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int32_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, int32_t, false, 
                                       dol_graph_traits<void, void, void, int32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int8_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, int8_t, false, 
                                       dol_graph_traits<void, void, void, int8_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int vertex id") {
        using graph_t = dynamic_graph<void, void, void, int, false, 
                                       dol_graph_traits<void, void, void, int, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
}
