...
TEMPLATE_TEST_CASE("unordered_map CPO vertices(g)",
                   "[dynamic_graph][cpo][vertices][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
  ...
  SECTION("sparse vertex IDs - key feature of map containers") {
    ...
    // Collect vertex IDs (order unspecified for unordered_map)
    std::vector<uint32_t> ids;
    for (auto v : v_range) {
      ids.push_back(vertex_id(g, v));
    }

    // Sort for comparison - order is unspecified
    std::ranges::sort(ids);
...
TEMPLATE_TEST_CASE("unordered_map CPO num_vertices(g)",
                   "[dynamic_graph][cpo][num_vertices][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO find_vertex(g, uid)",
                   "[dynamic_graph][cpo][find_vertex][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO vertex_id(g, u)",
                   "[dynamic_graph][cpo][vertex_id][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
  ...
  SECTION("contiguous IDs") {
    ...
    // Sort for comparison (order unspecified)
    std::ranges::sort(ids);
...
TEMPLATE_TEST_CASE("unordered_map CPO num_edges(g)",
                   "[dynamic_graph][cpo][num_edges][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO num_edges(g, u)",
                   "[dynamic_graph][cpo][num_edges][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO num_edges(g, uid)",
                   "[dynamic_graph][cpo][num_edges][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO edges(g, u)",
                   "[dynamic_graph][cpo][edges][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO edges(g, uid)",
                   "[dynamic_graph][cpo][edges][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO degree(g, u)",
                   "[dynamic_graph][cpo][degree][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO target_id(g, uv)",
                   "[dynamic_graph][cpo][target_id][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO target(g, uv)",
                   "[dynamic_graph][cpo][target][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO find_vertex_edge(g, uid, vid)",
                   "[dynamic_graph][cpo][find_vertex_edge][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO find_vertex_edge(g, u, v)",
                   "[dynamic_graph][cpo][find_vertex_edge][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO contains_edge(g, uid, vid)",
                   "[dynamic_graph][cpo][contains_edge][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO contains_edge(g, u, v)",
                   "[dynamic_graph][cpo][contains_edge][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO vertex_value(g, u)",
                   "[dynamic_graph][cpo][vertex_value][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
  ...
  SECTION("all vertices") {
    ...
    // Verify values (iteration order may differ, but we set by iteration)
    int total = 0;
    for (auto u : vertices(g)) {
      total += vertex_value(g, u);
    }
...
TEMPLATE_TEST_CASE("unordered_map CPO edge_value(g, uv)",
                   "[dynamic_graph][cpo][edge_value][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag) { // Note: uos, uous use set - const edges
  using Types        = graph_test_types<TestType>;
  using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO graph_value(g)",
                   "[dynamic_graph][cpo][graph_value][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO source_id(g, uv)",
                   "[dynamic_graph][cpo][source_id][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO source(g, uv)",
                   "[dynamic_graph][cpo][source][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO partition_id(g, u)",
                   "[dynamic_graph][cpo][partition_id][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO num_partitions(g)",
                   "[dynamic_graph][cpo][num_partitions][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO vertices(g, pid)",
                   "[dynamic_graph][cpo][vertices][partition][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO num_vertices(g, pid)",
                   "[dynamic_graph][cpo][num_vertices][partition][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO integration: sparse traversal",
                   "[dynamic_graph][cpo][integration][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag,
...
TEMPLATE_TEST_CASE("unordered_map CPO integration: values",
                   "[dynamic_graph][cpo][integration][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
                   uofl_tag) { // exclude set containers for edge modification
  using Types         = graph_test_types<TestType>;
  using Graph_all_int = typename Types::all_int;
  ...
  SECTION("access all value types") {
    ...
    // Vertex values: sum should be 10+20+30+40 = 100
    int vsum = 0;
    for (auto u : vertices(g)) {
      vsum += vertex_value(g, u);
    }
    REQUIRE(vsum == 100);
...
TEMPLATE_TEST_CASE("unordered_map CPO integration: modify vertex and edge values",
                   "[dynamic_graph][cpo][integration][unordered_map]",
                   uol_tag,
                   uov_tag,
                   uod_tag,
