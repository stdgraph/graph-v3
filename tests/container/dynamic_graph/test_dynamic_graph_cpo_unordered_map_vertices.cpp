...
TEMPLATE_TEST_CASE("unordered_map CPO num_edges(g, u)", "[dynamic_graph][cpo][num_edges][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO num_edges(g, uid)", "[dynamic_graph][cpo][num_edges][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO edges(g, uid)", "[dynamic_graph][cpo][edges][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
    ...
    SECTION("consistency with edges(g, u)") {
        ...
        for (auto u : vertices(g)) {
            ...
            for ([[maybe_unused]] auto uv : edges(g, u)) ++count_u;
            for ([[maybe_unused]] auto uv : edges(g, uid)) ++count_uid;
...
TEMPLATE_TEST_CASE("unordered_map CPO target(g, uv)", "[dynamic_graph][cpo][target][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][cpo][find_vertex_edge][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO find_vertex_edge(g, u, v)", "[dynamic_graph][cpo][find_vertex_edge][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO contains_edge(g, u, v)", "[dynamic_graph][cpo][contains_edge][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO edge_value(g, uv)", "[dynamic_graph][cpo][edge_value][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag) {  // Note: uos, uous use set - const edges
    using Types = graph_test_types<TestType>;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO source(g, uv)", "[dynamic_graph][cpo][source][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_sourced = typename Types::sourced_void;
    using Graph_sourced_int = typename Types::sourced_int;
...
TEMPLATE_TEST_CASE("unordered_map CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO num_vertices(g, pid)", "[dynamic_graph][cpo][num_vertices][partition][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag, uos_tag, uous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("unordered_map CPO integration: values", "[dynamic_graph][cpo][integration][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag) {  // exclude set containers for edge modification
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("unordered_map CPO integration: modify vertex and edge values", "[dynamic_graph][cpo][integration][unordered_map]",
                   uol_tag, uov_tag, uod_tag, uofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_vv = typename Types::int_vv;
    using Graph_int_ev = typename Types::int_ev;
