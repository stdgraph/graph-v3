...
using dos_void_void_void = dynamic_graph<void, void, void, uint32_t, false, dos_graph_traits<void, void, void, uint32_t, false>>;
using dos_int_void_void = dynamic_graph<int, void, void, uint32_t, false, dos_graph_traits<int, void, void, uint32_t, false>>;
using dos_void_int_void = dynamic_graph<void, int, void, uint32_t, false, dos_graph_traits<void, int, void, uint32_t, false>>;
using dos_int_int_void = dynamic_graph<int, int, void, uint32_t, false, dos_graph_traits<int, int, void, uint32_t, false>>;
using dos_void_void_int = dynamic_graph<void, void, int, uint32_t, false, dos_graph_traits<void, void, int, uint32_t, false>>;
using dos_int_int_int = dynamic_graph<int, int, int, uint32_t, false, dos_graph_traits<int, int, int, uint32_t, false>>;

using dos_string_string_string = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
...
using dos_int_sourced = dynamic_graph<int, void, void, uint32_t, true, dos_graph_traits<int, void, void, uint32_t, true>>;
