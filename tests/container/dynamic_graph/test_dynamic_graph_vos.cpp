...
using vos_void_void_void =
      vos_graph<void, void, void>;
using vos_int_void_void =
      vos_graph<int, void, void>;
using vos_void_int_void =
      vos_graph<void, int, void>;
using vos_int_int_void =
      vos_graph<int, int, void>;
using vos_void_void_int =
      vos_graph<void, void, int>;
using vos_int_int_int = vos_graph<int, int, int>;
