 ...
 * Tests vos_graph_traits (vector vertices + set edges)
 * 
...
using vos_void_void_void = dynamic_graph<void, void, void, uint32_t, false, vos_graph_traits<void, void, void, uint32_t, false>>;
using vos_int_void_void = dynamic_graph<int, void, void, uint32_t, false, vos_graph_traits<int, void, void, uint32_t, false>>;
using vos_void_int_void = dynamic_graph<void, int, void, uint32_t, false, vos_graph_traits<void, int, void, uint32_t, false>>;
using vos_int_int_void = dynamic_graph<int, int, void, uint32_t, false, vos_graph_traits<int, int, void, uint32_t, false>>;
using vos_void_void_int = dynamic_graph<void, void, int, uint32_t, false, vos_graph_traits<void, void, int, uint32_t, false>>;
using vos_int_int_int = dynamic_graph<int, int, int, uint32_t, false, vos_graph_traits<int, int, int, uint32_t, false>>;
...
using vos_sourced = dynamic_graph<void, void, void, uint32_t, true, vos_graph_traits<void, void, void, uint32_t, true>>;
using vos_int_sourced = dynamic_graph<int, void, void, uint32_t, true, vos_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("vos default construction", "[vos][construction]") {
...
TEST_CASE("vos constructor with graph value", "[vos][construction]") {
...
TEST_CASE("vos load_edges", "[vos][load]") {
...
TEST_CASE("vos initializer list construction", "[vos][construction][initializer_list]") {
...
TEST_CASE("vos edge deduplication", "[vos][set][deduplication]") {
...
TEST_CASE("vos edges are sorted by target_id", "[vos][set][sorted]") {
...
TEST_CASE("vos vertex access", "[vos][vertex][access]") {
...
TEST_CASE("vos vertex iteration", "[vos][vertex][iteration]") {
...
TEST_CASE("vos edge access", "[vos][edge][access]") {
...
TEST_CASE("vos edge bidirectional iteration", "[vos][edge][iteration]") {
...
TEST_CASE("vos vertex values", "[vos][vertex][value]") {
...
TEST_CASE("vos edge values", "[vos][edge][value]") {
...
TEST_CASE("vos sourced edges", "[vos][sourced]") {
...
TEST_CASE("vos self-loops", "[vos][self-loop]") {
...
TEST_CASE("vos large graph", "[vos][performance]") {
...
TEST_CASE("vos set iterator stability", "[vos][set][iterator]") {
...
TEST_CASE("vos algorithm compatibility", "[vos][algorithm]") {
...
TEST_CASE("vos edge cases", "[vos][edge-cases]") {
...
TEST_CASE("vos type traits", "[vos][traits]") {
    SECTION("edge_type is correct") {
        using traits = vos_graph_traits<int, void, void, uint32_t, false>;
    ...
    SECTION("edges_type is std::set") {
        using traits = vos_graph_traits<void, void, void, uint32_t, false>;
    ...
    SECTION("sourced trait") {
        using traits_unsourced = vos_graph_traits<void, void, void, uint32_t, false>;
        using traits_sourced = vos_graph_traits<void, void, void, uint32_t, true>;
...
TEST_CASE("vos complex structures", "[vos][complex]") {
