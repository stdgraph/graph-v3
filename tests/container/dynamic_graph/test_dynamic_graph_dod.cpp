...
using dod_void_void_void = dynamic_graph<void, void, void, uint32_t, false, dod_graph_traits<void, void, void, uint32_t, false>>;
using dod_int_void_void = dynamic_graph<int, void, void, uint32_t, false, dod_graph_traits<int, void, void, uint32_t, false>>;
using dod_void_int_void = dynamic_graph<void, int, void, uint32_t, false, dod_graph_traits<void, int, void, uint32_t, false>>;
using dod_int_int_void = dynamic_graph<int, int, void, uint32_t, false, dod_graph_traits<int, int, void, uint32_t, false>>;
using dod_void_void_int = dynamic_graph<void, void, int, uint32_t, false, dod_graph_traits<void, void, int, uint32_t, false>>;
using dod_int_int_int = dynamic_graph<int, int, int, uint32_t, false, dod_graph_traits<int, int, int, uint32_t, false>>;

using dod_string_string_string = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
...
using dod_int_sourced = dynamic_graph<int, void, void, uint32_t, true, dod_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("dod value types", "[dod][value_types]") {
    SECTION("with void edge value") {
        using graph_t = dynamic_graph<void, int, int, uint32_t, false, dod_graph_traits<void, int, int, uint32_t, false>>;
        graph_t g(100);
        REQUIRE(g.graph_value() == 100);
    }

    SECTION("with void vertex value") {
        using graph_t = dynamic_graph<int, void, int, uint32_t, false, dod_graph_traits<int, void, int, uint32_t, false>>;
        graph_t g(100);
        REQUIRE(g.graph_value() == 100);
    }

    SECTION("with void graph value") {
        using graph_t = dynamic_graph<int, int, void, uint32_t, false, dod_graph_traits<int, int, void, uint32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
...
TEST_CASE("dod vertex ID types", "[dod][vertex_id]") {
    SECTION("with uint32_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, uint32_t, false, 
                                       dod_graph_traits<void, void, void, uint32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int32_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, int32_t, false, 
                                       dod_graph_traits<void, void, void, int32_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int8_t vertex id") {
        using graph_t = dynamic_graph<void, void, void, int8_t, false, 
                                       dod_graph_traits<void, void, void, int8_t, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("with int vertex id") {
        using graph_t = dynamic_graph<void, void, void, int, false, 
                                       dod_graph_traits<void, void, void, int, false>>;
        graph_t g;
        REQUIRE(g.size() == 0);
    }
}
