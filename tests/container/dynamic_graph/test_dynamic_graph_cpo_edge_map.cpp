...
TEMPLATE_TEST_CASE("edge_map CPO vertices(g)", "[dynamic_graph][cpo][vertices][edge_map]",
                   voem_tag, moem_tag) {
...
TEMPLATE_TEST_CASE("edge_map CPO num_vertices(g)", "[dynamic_graph][cpo][num_vertices][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO find_vertex(g, uid)", "[dynamic_graph][cpo][find_vertex][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO vertex_id(g, u)", "[dynamic_graph][cpo][vertex_id][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO num_edges(g)", "[dynamic_graph][cpo][num_edges][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO has_edge(g)", "[dynamic_graph][cpo][has_edge][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO edges(g, u)", "[dynamic_graph][cpo][edges][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO degree(g, u)", "[dynamic_graph][cpo][degree][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO target_id(g, uv)", "[dynamic_graph][cpo][target_id][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO target(g, uv)", "[dynamic_graph][cpo][target][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][cpo][find_vertex_edge][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO contains_edge(g, uid, vid)", "[dynamic_graph][cpo][contains_edge][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO vertex_value(g, u)", "[dynamic_graph][cpo][vertex_value][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
...
TEMPLATE_TEST_CASE("edge_map CPO edge_value(g, uv)", "[dynamic_graph][cpo][edge_value][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO graph_value(g)", "[dynamic_graph][cpo][graph_value][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
...
TEMPLATE_TEST_CASE("edge_map CPO source_id(g, uv)", "[dynamic_graph][cpo][source_id][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
...
TEMPLATE_TEST_CASE("edge_map CPO source(g, uv)", "[dynamic_graph][cpo][source][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_sourced = typename Types::sourced_void;
    using Graph_sourced_int = typename Types::sourced_int;
...
TEMPLATE_TEST_CASE("edge_map CPO partition_id(g, u)", "[dynamic_graph][cpo][partition_id][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("edge_map CPO num_partitions(g)", "[dynamic_graph][cpo][num_partitions][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("edge_map CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("edge_map CPO num_vertices(g, pid)", "[dynamic_graph][cpo][num_vertices][partition][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("edge_map CPO integration: duplicate edges", "[dynamic_graph][cpo][integration][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("edge_map CPO integration: values", "[dynamic_graph][cpo][integration][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("edge_map CPO integration: traversal", "[dynamic_graph][cpo][integration][edge_map]",
                   voem_tag, moem_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
