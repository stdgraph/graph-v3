...
using mofl_void_void_void =
      dynamic_graph<void, void, void, uint32_t, false, mofl_graph_traits<void, void, void, uint32_t, false>>;
using mofl_int_void_void =
      dynamic_graph<int, void, void, uint32_t, false, mofl_graph_traits<int, void, void, uint32_t, false>>;
using mofl_void_int_void =
      dynamic_graph<void, int, void, uint32_t, false, mofl_graph_traits<void, int, void, uint32_t, false>>;
using mofl_int_int_void =
      dynamic_graph<int, int, void, uint32_t, false, mofl_graph_traits<int, int, void, uint32_t, false>>;
using mofl_void_void_int =
      dynamic_graph<void, void, int, uint32_t, false, mofl_graph_traits<void, void, int, uint32_t, false>>;
using mofl_int_int_int =
      dynamic_graph<int, int, int, uint32_t, false, mofl_graph_traits<int, int, int, uint32_t, false>>;

// Type aliases with string vertex IDs (the primary use case for map containers)
using mofl_str_void_void_void =
      dynamic_graph<void, void, void, std::string, false, mofl_graph_traits<void, void, void, std::string, false>>;
using mofl_str_int_void_void =
      dynamic_graph<int, void, void, std::string, false, mofl_graph_traits<int, void, void, std::string, false>>;
using mofl_str_void_int_void =
      dynamic_graph<void, int, void, std::string, false, mofl_graph_traits<void, int, void, std::string, false>>;
