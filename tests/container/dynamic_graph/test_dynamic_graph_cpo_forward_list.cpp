...
TEMPLATE_TEST_CASE("forward_list CPO vertices(g)", "[dynamic_graph][cpo][vertices]",
                   vofl_tag, dofl_tag) {
...
TEMPLATE_TEST_CASE("forward_list CPO num_vertices(g)", "[dynamic_graph][cpo][num_vertices]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_vv = typename Types::int_vv;
...
TEMPLATE_TEST_CASE("forward_list CPO find_vertex(g, uid)", "[dynamic_graph][cpo][find_vertex]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO vertex_id(g, u)", "[dynamic_graph][cpo][vertex_id]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO num_edges(g)", "[dynamic_graph][cpo][num_edges]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO has_edge(g)", "[dynamic_graph][cpo][has_edge]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO edges(g, u)", "[dynamic_graph][cpo][edges]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO edges(g, uid)", "[dynamic_graph][cpo][edges]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO degree(g, u)", "[dynamic_graph][cpo][degree]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO target_id(g, uv)", "[dynamic_graph][cpo][target_id]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO target(g, uv)", "[dynamic_graph][cpo][target]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][cpo][find_vertex_edge]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO find_vertex_edge(g, u, v)", "[dynamic_graph][cpo][find_vertex_edge]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO contains_edge(g, uid, vid)", "[dynamic_graph][cpo][contains_edge]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO contains_edge(g, u, v)", "[dynamic_graph][cpo][contains_edge]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO vertex_value(g, u)", "[dynamic_graph][cpo][vertex_value]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_vv = typename Types::int_vv;
    using Graph_string = typename Types::string_type;
...
TEMPLATE_TEST_CASE("forward_list CPO edge_value(g, uv)", "[dynamic_graph][cpo][edge_value]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_ev = typename Types::int_ev;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("forward_list CPO graph_value(g)", "[dynamic_graph][cpo][graph_value]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
    using Graph_string = typename Types::string_type;
...
TEMPLATE_TEST_CASE("forward_list CPO partition_id(g, u)", "[dynamic_graph][cpo][partition_id]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO num_partitions(g)", "[dynamic_graph][cpo][num_partitions]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("forward_list CPO source_id(g, uv)", "[dynamic_graph][cpo][source_id]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
...
TEMPLATE_TEST_CASE("forward_list CPO source(g, uv)", "[dynamic_graph][cpo][source]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_sourced_void = typename Types::sourced_void;
    using Graph_sourced_int = typename Types::sourced_int;
...
TEMPLATE_TEST_CASE("forward_list CPO integration", "[dynamic_graph][cpo][integration]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
...
TEMPLATE_TEST_CASE("forward_list CPO integration: values", "[dynamic_graph][cpo][integration]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("forward_list CPO integration: modify vertex and edge values", "[dynamic_graph][cpo][integration]",
                   vofl_tag, dofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
