...
using mol_void_void_void =
      mol_graph<void, void, void>;
using mol_int_void_void =
      mol_graph<int, void, void>;
using mol_void_int_void =
      mol_graph<void, int, void>;
using mol_int_int_void =
      mol_graph<int, int, void>;
using mol_void_void_int =
      mol_graph<void, void, int>;
using mol_int_int_int = mol_graph<int, int, int>;
...
using mol_str_void_int_void =
      mol_graph<void, int, void, std::string>;
using mol_str_int_int_int =
      mol_graph<int, int, int, std::string>;
