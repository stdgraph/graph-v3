...
using uov_int_sourced =
      dynamic_graph<int, void, void, uint32_t, true, uov_graph_traits<int, void, void, uint32_t, true>>;

using uov_str_sourced =
      dynamic_graph<void, void, void, std::string, true, uov_graph_traits<void, void, void, std::string, true>>;
