...
TEMPLATE_TEST_CASE("map CPO num_edges(g, u)", "[dynamic_graph][cpo][num_edges][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO num_edges(g, uid)", "[dynamic_graph][cpo][num_edges][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO edges(g, uid)", "[dynamic_graph][cpo][edges][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO find_vertex_edge(g, u, v)", "[dynamic_graph][cpo][find_vertex_edge][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO contains_edge(g, u, v)", "[dynamic_graph][cpo][contains_edge][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO source(g, uv)", "[dynamic_graph][cpo][source][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_sourced = typename Types::sourced_void;
    using Graph_sourced_int = typename Types::sourced_int;
...
TEMPLATE_TEST_CASE("map CPO vertices(g, pid)", "[dynamic_graph][cpo][vertices][partition][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO num_vertices(g, pid)", "[dynamic_graph][cpo][num_vertices][partition][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag, mos_tag, mous_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_void = typename Types::void_type;
    using Graph_int_ev = typename Types::int_ev;
...
TEMPLATE_TEST_CASE("map CPO integration: values", "[dynamic_graph][cpo][integration][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag) {  // exclude set containers for edge modification
    using Types = graph_test_types<TestType>;
    using Graph_all_int = typename Types::all_int;
...
TEMPLATE_TEST_CASE("map CPO integration: modify vertex and edge values", "[dynamic_graph][cpo][integration][map]",
                   mol_tag, mov_tag, mod_tag, mofl_tag) {
    using Types = graph_test_types<TestType>;
    using Graph_int_vv = typename Types::int_vv;
    using Graph_int_ev = typename Types::int_ev;
