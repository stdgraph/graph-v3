/**
 * @file test_dynamic_graph_cpo_vous.cpp
 * @brief Phase 4.2.2d CPO tests for dynamic_graph with vous_graph_traits
 * 
 ...
 * 
 * Container: vector<vertex> + unordered_set<edge>
 * 
 ...
 * - vous: Edges stored unordered, O(1) average operations, forward iterators only
...
using vous_void     = dynamic_graph<void, void, void, uint32_t, false, vous_graph_traits<void, void, void, uint32_t, false>>;
using vous_int_ev   = dynamic_graph<int, void, void, uint32_t, false, vous_graph_traits<int, void, void, uint32_t, false>>;
using vous_int_vv   = dynamic_graph<void, int, void, uint32_t, false, vous_graph_traits<void, int, void, uint32_t, false>>;
using vous_all_int  = dynamic_graph<int, int, int, uint32_t, false, vous_graph_traits<int, int, int, uint32_t, false>>;
using vous_string   = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
...
using vous_sourced_void = dynamic_graph<void, void, void, uint32_t, true, vous_graph_traits<void, void, void, uint32_t, true>>;
using vous_sourced_int  = dynamic_graph<int, void, void, uint32_t, true, vous_graph_traits<int, void, void, uint32_t, true>>;
using vous_sourced_all  = dynamic_graph<int, int, int, uint32_t, true, vous_graph_traits<int, int, int, uint32_t, true>>;
...
TEST_CASE("vos CPO vertices(g)", "[dynamic_graph][vous][cpo][vertices]") {
...
TEST_CASE("vos CPO num_vertices(g)", "[dynamic_graph][vous][cpo][num_vertices]") {
    SECTION("empty graph") {
        vous_void g;
...
TEST_CASE("vos CPO find_vertex(g, uid)", "[dynamic_graph][vous][cpo][find_vertex]") {
...
TEST_CASE("vos CPO vertex_id(g, u)", "[dynamic_graph][vous][cpo][vertex_id]") {
...
TEST_CASE("vos CPO num_edges(g)", "[dynamic_graph][vous][cpo][num_edges]") {
    SECTION("empty graph") {
        vous_void g;
...
// NOTE: num_edges(g, u) and num_edges(g, uid) NOT supported with vous_graph_traits
...
TEST_CASE("vos CPO edges(g, u)", "[dynamic_graph][vous][cpo][edges]") {
...
TEST_CASE("vos CPO edges(g, uid)", "[dynamic_graph][vous][cpo][edges]") {
    SECTION("basic iteration") {
        vous_void g({{0, 1}, {0, 2}});
...
TEST_CASE("vos CPO degree(g, u)", "[dynamic_graph][vous][cpo][degree]") {
    ...
    SECTION("multiple vertices") {
        vous_void g({{0, 1}, {0, 2}, {1, 2}, {2, 0}, {2, 1}});
...
TEST_CASE("vos CPO target_id(g, uv)", "[dynamic_graph][vous][cpo][target_id]") {
    SECTION("basic access") {
        vous_void g({{0, 5}});
    ...
    SECTION("all edges") {
        ...
        // Check edges from vertex 0
        {
            ...
            REQUIRE(targets == std::vector<uint32_t>{1, 2});  // After sorting
        }
...
TEST_CASE("vos CPO target(g, uv)", "[dynamic_graph][vous][cpo][target]") {
    SECTION("basic access") {
        vous_void g({{0, 1}});
...
TEST_CASE("vos CPO find_vertex_edge(g, u, v)", "[dynamic_graph][vous][cpo][find_vertex_edge]") {
...
TEST_CASE("vos CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][vous][cpo][find_vertex_edge][uid_vid]") {
    SECTION("existing edge") {
        vous_void g({{0, 1}, {0, 2}});
...
TEST_CASE("vos CPO contains_edge(g, u, v)", "[dynamic_graph][vous][cpo][contains_edge]") {
    SECTION("existing edge") {
        vous_void g({{0, 1}, {1, 2}});
...
TEST_CASE("vos CPO contains_edge(g, uid, vid)", "[dynamic_graph][vous][cpo][contains_edge][uid_vid]") {
    SECTION("existing edge") {
        vous_void g({{0, 1}, {1, 2}});
...
TEST_CASE("vos CPO has_edge(g)", "[dynamic_graph][vous][cpo][has_edge]") {
    SECTION("empty graph") {
        vous_void g;
...
TEST_CASE("vos CPO vertex_value(g, u)", "[dynamic_graph][vous][cpo][vertex_value]") {
    SECTION("read access") {
        vous_int_vv g;
...
TEST_CASE("vos CPO edge_value(g, uv)", "[dynamic_graph][vous][cpo][edge_value]") {
    SECTION("read access") {
        vous_int_ev g;
        std::vector<edge_int> ee = {{0, 1, 100}, {0, 2, 200}};
        g.load_edges(ee, std::identity{});
...
TEST_CASE("vos CPO graph_value(g)", "[dynamic_graph][vous][cpo][graph_value]") {
    SECTION("read access") {
        vous_all_int g(42);
    ...
    SECTION("const correctness") {
        const vous_all_int g(99);
        
        REQUIRE(graph_value(g) == 99);
    }

    SECTION("string value") {
        vous_string g(std::string("test"));
...
TEST_CASE("vos CPO partition_id(g, u)", "[dynamic_graph][vous][cpo][partition_id]") {
...
TEST_CASE("vos CPO num_partitions(g)", "[dynamic_graph][vous][cpo][num_partitions]") {
...
TEST_CASE("vos CPO vertices(g, pid)", "[dynamic_graph][vous][cpo][vertices][partition]") {
...
TEST_CASE("vos CPO num_vertices(g, pid)", "[dynamic_graph][vous][cpo][num_vertices][partition]") {
...
TEST_CASE("vos CPO source_id(g, uv)", "[dynamic_graph][vous][cpo][source_id]") {
    SECTION("basic access") {
        vous_sourced_void g({{0, 1}, {0, 2}, {1, 2}});
    ...
    SECTION("multiple sources") {
        vous_sourced_void g({{0, 2}, {1, 2}, {2, 0}});
...
TEST_CASE("vos CPO source(g, uv)", "[dynamic_graph][vous][cpo][source]") {
    SECTION("basic access") {
        vous_sourced_void g({{0, 1}, {1, 2}});
...
TEST_CASE("vos CPO integration", "[dynamic_graph][vous][cpo][integration]") {
    ...
    SECTION("graph traversal") {
        vous_void g({{0, 1}, {1, 2}, {2, 3}, {3, 0}});  // Cycle
    ...
    SECTION("unordered_set-specific: edges unordered") {
        ...
        std::ranges::sort(target_ids);
        REQUIRE(target_ids == std::vector<uint32_t>{1, 3, 5, 9});
    }
...
TEST_CASE("vos CPO integration: modify vertex and edge values", "[dynamic_graph][vous][cpo][integration]") {
