/**
 * @file test_dynamic_graph_uofl.cpp
 * @brief Tests for dynamic_graph with unordered_map vertices + forward_list edges
 * 
 * Phase 3.1e: Unordered Map Vertex Containers
 * Tests uofl_graph_traits (unordered_map vertices + forward_list edges)
 ...
 * This file focuses on uofl_graph_traits specific functionality.
 */
...
using uofl_void_void_void = dynamic_graph<void, void, void, uint32_t, false, uofl_graph_traits<void, void, void, uint32_t, false>>;
using uofl_int_void_void = dynamic_graph<int, void, void, uint32_t, false, uofl_graph_traits<int, void, void, uint32_t, false>>;
using uofl_void_int_void = dynamic_graph<void, int, void, uint32_t, false, uofl_graph_traits<void, int, void, uint32_t, false>>;
using uofl_int_int_void = dynamic_graph<int, int, void, uint32_t, false, uofl_graph_traits<int, int, void, uint32_t, false>>;
using uofl_void_void_int = dynamic_graph<void, void, int, uint32_t, false, uofl_graph_traits<void, void, int, uint32_t, false>>;
using uofl_int_int_int = dynamic_graph<int, int, int, uint32_t, false, uofl_graph_traits<int, int, int, uint32_t, false>>;

// Type aliases with string vertex IDs (a common use case for unordered_map containers)
using uofl_str_void_void_void = dynamic_graph<void, void, void, std::string, false, uofl_graph_traits<void, void, void, std::string, false>>;
using uofl_str_int_void_void = dynamic_graph<int, void, void, std::string, false, uofl_graph_traits<int, void, void, std::string, false>>;
using uofl_str_void_int_void = dynamic_graph<void, int, void, std::string, false, uofl_graph_traits<void, int, void, std::string, false>>;
using uofl_str_int_int_int = dynamic_graph<int, int, int, std::string, false, uofl_graph_traits<int, int, int, std::string, false>>;

using uofl_sourced = dynamic_graph<void, void, void, uint32_t, true, uofl_graph_traits<void, void, void, uint32_t, true>>;
using uofl_int_sourced = dynamic_graph<int, void, void, uint32_t, true, uofl_graph_traits<int, void, void, uint32_t, true>>;
...
TEST_CASE("uofl traits verification", "[dynamic_graph][uofl][traits]") {
    SECTION("vertices_type is std::unordered_map") {
        using traits = uofl_graph_traits<void, void, void, uint32_t, false>;
    ...
    SECTION("vertex_id_type can be string") {
        using traits = uofl_graph_traits<void, void, void, std::string, false>;
        static_assert(std::same_as<typename traits::vertex_id_type, std::string>);
        REQUIRE(true);
    }

    SECTION("sourced flag is preserved") {
        using traits_unsourced = uofl_graph_traits<void, void, void, uint32_t, false>;
        using traits_sourced = uofl_graph_traits<void, void, void, uint32_t, true>;
    ...
    SECTION("custom vertex_id_type") {
        using traits = uofl_graph_traits<void, void, void, int64_t, false>;
...
TEST_CASE("uofl iterator categories", "[dynamic_graph][uofl][iterators]") {
    ...
    SECTION("graph is a range") {
        static_assert(std::ranges::range<uofl_void_void_void>);
        static_assert(std::ranges::range<uofl_int_int_int>);
        static_assert(std::ranges::range<uofl_str_void_void_void>);
        REQUIRE(true);
    }
}
...
TEST_CASE("uofl construction", "[dynamic_graph][uofl][construction]") {
    SECTION("default constructor creates empty graph") {
        uofl_void_void_void g;
        REQUIRE(g.size() == 0);
    }
    ...
    SECTION("copy constructor") {
        uofl_int_int_int g1;
        uofl_int_int_int g2(g1);
        REQUIRE(g2.size() == g1.size());
    }

    SECTION("move constructor") {
        uofl_int_int_int g1;
        uofl_int_int_int g2(std::move(g1));
        REQUIRE(g2.size() == 0);
    }

    SECTION("copy assignment") {
        uofl_int_int_int g1, g2;
        g2 = g1;
        REQUIRE(g2.size() == g1.size());
    }
...
TEST_CASE("uofl construction with string vertex IDs", "[dynamic_graph][uofl][construction][string]") {
    SECTION("default constructor creates empty graph") {
        uofl_str_void_void_void g;
        REQUIRE(g.size() == 0);
    }

    SECTION("default constructor with int edge values") {
        uofl_str_int_void_void g;
        REQUIRE(g.size() == 0);
    }

    SECTION("default constructor with int vertex values") {
        uofl_str_void_int_void g;
        REQUIRE(g.size() == 0);
    }

    SECTION("default constructor with all int values") {
        uofl_str_int_int_int g;
        REQUIRE(g.size() == 0);
    }
}

TEST_CASE("uofl construction sourced", "[dynamic_graph][uofl][construction][sourced]") {
...
TEST_CASE("uofl properties", "[dynamic_graph][uofl][properties]") {
...
TEST_CASE("uofl properties with string IDs", "[dynamic_graph][uofl][properties][string]") {
    SECTION("size() on empty graph") {
        uofl_str_void_void_void g;
        REQUIRE(g.size() == 0);
    }
...
TEST_CASE("uofl type aliases", "[dynamic_graph][uofl][types]") {
    SECTION("graph type aliases are correct") {
        using G = uofl_int_int_int;
...
TEST_CASE("uofl initializer_list construction", "[dynamic_graph][uofl][initializer_list]") {
    ...
    SECTION("sparse vertex IDs - only referenced vertices created") {
        ...
        G g({{100, 200}});
        REQUIRE(g.size() == 2);
        // With uofl, only vertices 100 and 200 are created
...
TEST_CASE("uofl initializer_list construction string IDs", "[dynamic_graph][uofl][initializer_list][string]") {
    SECTION("single edge with string IDs") {
        using G = uofl_str_void_void_void;
        G g({{"alice", "bob"}});
        REQUIRE(g.size() == 2);
    }

    SECTION("string IDs with edge values") {
        using G = uofl_str_int_void_void;
...
TEST_CASE("uofl graph value access", "[dynamic_graph][uofl][graph_value]") {
    SECTION("graph_value() returns reference") {
        uofl_void_void_int g(100);
    ...
    SECTION("const graph_value()") {
        const uofl_void_void_int g(42);
        REQUIRE(g.graph_value() == 42);
    }

    SECTION("graph value preserved through copy") {
        uofl_void_void_int g1(100);
        uofl_void_void_int g2 = g1;
    ...
    SECTION("graph value preserved through move") {
        uofl_void_void_int g1(100);
        uofl_void_void_int g2 = std::move(g1);
        REQUIRE(g2.graph_value() == 100);
    }
}
...
TEST_CASE("uofl graph iteration", "[dynamic_graph][uofl][iteration]") {
    ...
    SECTION("iteration order is unspecified (hash-based)") {
        // Unlike mofl (map), uofl does NOT iterate in key order
        using G = uofl_void_void_void;
        G g({{5, 10}, {1, 2}, {3, 4}});
...
TEST_CASE("uofl edge cases", "[dynamic_graph][uofl][edge_cases]") {
...
TEST_CASE("uofl const correctness", "[dynamic_graph][uofl][const]") {
...
TEST_CASE("uofl memory management", "[dynamic_graph][uofl][memory]") {
...
TEST_CASE("uofl template instantiation", "[dynamic_graph][uofl][compilation]") {
    [[maybe_unused]] uofl_void_void_void g1;
    [[maybe_unused]] uofl_int_void_void g2;
    [[maybe_unused]] uofl_void_int_void g3;
    [[maybe_unused]] uofl_int_int_void g4;
    [[maybe_unused]] uofl_void_void_int g5;
    [[maybe_unused]] uofl_int_int_int g6;
    [[maybe_unused]] uofl_sourced g7;
    [[maybe_unused]] uofl_int_sourced g8;
    [[maybe_unused]] uofl_str_void_void_void g9;
    [[maybe_unused]] uofl_str_int_void_void g10;
    [[maybe_unused]] uofl_str_int_int_int g11;
    [[maybe_unused]] uofl_str_sourced g12;
...
TEST_CASE("uofl sparse vertex behavior", "[dynamic_graph][uofl][sparse]") {
...
TEST_CASE("uofl contains_vertex", "[dynamic_graph][uofl][accessor][contains_vertex]") {
...
TEST_CASE("uofl try_find_vertex", "[dynamic_graph][uofl][accessor][try_find_vertex]") {
...
TEST_CASE("uofl vertex_at", "[dynamic_graph][uofl][accessor][vertex_at]") {
    SECTION("uint32_t vertex IDs - found") {
        using G = uofl_void_void_void;
        G g({{0, 1}, {1, 2}});
    ...
    SECTION("modify vertex through vertex_at") {
        using G = uofl_void_int_void;  // has vertex value
        G g({{0, 1}});
...
TEST_CASE("uofl load_vertices", "[dynamic_graph][uofl][load_vertices]") {
    SECTION("uint32_t IDs - basic load") {
        using G = uofl_void_int_void;  // vertex value = int
    ...
    SECTION("string IDs - basic load") {
        using G = uofl_str_void_int_void;  // string keys, vertex value = int
    ...
    SECTION("string IDs - load creates new vertices") {
        using G = uofl_str_void_int_void;
        using vertex_data = copyable_vertex_t<std::string, int>;
...
TEST_CASE("uofl load_edges explicit", "[dynamic_graph][uofl][load_edges]") {
    SECTION("uint32_t IDs - basic load") {
        using G = uofl_int_void_void;  // edge value = int
    ...
    SECTION("string IDs - basic load") {
        using G = uofl_str_int_void_void;  // string keys, edge value = int
...
TEST_CASE("uofl load_vertices and load_edges combined", "[dynamic_graph][uofl][load]") {
    SECTION("load edges then vertices") {
        using G = uofl_int_int_void;  // edge value = int, vertex value = int
        using vertex_data = copyable_vertex_t<uint32_t, int>;
        using edge_data = copyable_edge_t<uint32_t, int>;
    ...
    SECTION("string IDs - combined loading") {
        using G = uofl_str_int_int_int;  // all values are int
        using vertex_data = copyable_vertex_t<std::string, int>;
        using edge_data = copyable_edge_t<std::string, int>;
...
TEST_CASE("uofl hash-specific behavior", "[dynamic_graph][uofl][hash]") {
...
//==================================================================================================
// Summary: Phase 3.1e uofl_graph_traits Tests
//
// This file tests uofl_graph_traits (unordered_map vertices + forward_list edges).
// 
