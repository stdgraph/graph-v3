...
TEST_CASE("neighbors - vertex with no neighbors", "[neighbors][empty]") {
  ...
  SECTION("with value function - empty iteration") {
    ...
    auto nlist = neighbors(g, v0, [](const auto&, auto /*v*/) { return 42; });
...
TEST_CASE("neighbors - vertex with single neighbor", "[neighbors][single]") {
  ...
  SECTION("with value function") {
    auto v0    = vertex_t<Graph>{0};
    auto nlist = neighbors(g, v0, [](const auto&, auto v) { return v.vertex_id() * 10; });
...
TEST_CASE("neighbors - vertex with multiple neighbors", "[neighbors][multiple]") {
  ...
  SECTION("with value function") {
    ...
    auto nlist = neighbors(g, v1, [](const auto&, auto v) { return static_cast<int>(v.vertex_id() * 100); });
  ...
  SECTION("structured binding - with value function") {
    auto v0    = vertex_t<Graph>{0};
    auto nlist = neighbors(g, v0, [](const auto&, auto v) { return v.vertex_id() + 100; });
...
TEST_CASE("neighbors - value function types", "[neighbors][vvf]") {
  using Graph = std::vector<std::vector<int>>;
  Graph g     = {{1, 2}, // vertex 0 -> neighbors 1, 2
                 {},
                 {}};
  auto  v0    = vertex_t<Graph>{0};

  SECTION("returning string") {
    auto nlist = neighbors(g, v0, [](const auto&, auto v) { return "neighbor_" + std::to_string(v.vertex_id()); });
  ...
  SECTION("returning double") {
    auto nlist = neighbors(g, v0, [](const auto&, auto v) { return static_cast<double>(v.vertex_id()) * 1.5; });
  ...
  SECTION("capturing lambda") {
    ...
    auto        nlist =
          neighbors(g, v0, [multiplier](const auto&, auto v) { return static_cast<int>(v.vertex_id() * multiplier); });
...
TEST_CASE("neighbors - vertex descriptor access", "[neighbors][descriptor]") {
  using Graph = std::vector<std::vector<int>>;
  Graph g     = {{1, 2, 3}, // vertex 0 -> neighbors 1, 2, 3
                 {},
                 {},
                 {}};
  auto  v0    = vertex_t<Graph>{0};
...
TEST_CASE("neighbors - weighted graph", "[neighbors][weighted]") {
  ...
  SECTION("value function accessing neighbor properties") {
    ...
    auto nlist = neighbors(g, v0, [](const auto&, auto v) { return v.vertex_id() * v.vertex_id(); });
...
TEST_CASE("neighbors - range concepts", "[neighbors][concepts]") {
  ...
  SECTION("with value function") {
    auto nlist = neighbors(g, v0, [](const auto&, auto v) { return v.vertex_id(); });
...
TEST_CASE("neighbors - std::ranges algorithms", "[neighbors][algorithms]") {
  using Graph = std::vector<std::vector<int>>;
  Graph g     = {{1, 2, 3, 4, 5}, // vertex 0 -> neighbors 1-5
                 {},
                 {},
                 {},
                 {},
  ...
  SECTION("std::ranges::count_if") {
    auto nlist = neighbors(g, v0);
    auto count = std::ranges::count_if(nlist, [](auto ni) { return ni.target_id > 2; });
...
TEST_CASE("neighbors - map vertices vector edges", "[neighbors][map]") {
  ...
  SECTION("with value function") {
    ...
    auto nlist = neighbors(g, v100, [](const auto&, auto v) {
...
TEST_CASE("neighbors - map vertices map edges", "[neighbors][map][edge_map]") {
  ...
  SECTION("with value function") {
    ...
    auto nlist = neighbors(g, v10, [](const auto&, auto v) { return v.vertex_id() * 2; });
