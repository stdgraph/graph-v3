...
TEST_CASE("vertex_data: all 8 specializations compile", "[vertex_data]") {
  SECTION("VId, V, VV all present") {
    vertex_data<int, mock_vertex_descriptor, mock_value> vi{1, mock_vertex_descriptor{1}, mock_value{42.0}};
    REQUIRE(vi.id == 1);
  ...
  SECTION("VId, V present; VV=void") {
    vertex_data<int, mock_vertex_descriptor, void> vi{2, mock_vertex_descriptor{2}};
    REQUIRE(vi.id == 2);
  ...
  SECTION("VId, VV present; V=void") {
    vertex_data<int, void, mock_value> vi{3, mock_value{99.9}};
    REQUIRE(vi.id == 3);
  ...
  SECTION("VId present; V=void, VV=void") {
    vertex_data<int, void, void> vi{4};
    REQUIRE(vi.id == 4);
    STATIC_REQUIRE(std::is_void_v<decltype(vi)::vertex_type>);
    STATIC_REQUIRE(std::is_void_v<decltype(vi)::value_type>);
  }
  ...
  SECTION("VId=void; V, VV present (descriptor-based pattern)") {
    vertex_data<void, mock_vertex_descriptor, mock_value> vi{mock_vertex_descriptor{5}, mock_value{123.4}};
  ...
  SECTION("VId=void, VV=void; V present") {
    vertex_data<void, mock_vertex_descriptor, void> vi{mock_vertex_descriptor{6}};
  ...
  SECTION("VId=void, V=void; VV present") {
    vertex_data<void, void, mock_value> vi{mock_value{77.7}};
...
TEST_CASE("vertex_data: structured bindings work correctly", "[vertex_data]") {
...
TEST_CASE("vertex_data: sizeof verifies physical absence of void members", "[vertex_data]") {
  SECTION("Full struct vs VId=void reduces size") {
    using full_t  = vertex_data<int, mock_vertex_descriptor, mock_value>;
    using no_id_t = vertex_data<void, mock_vertex_descriptor, mock_value>;
  ...
  SECTION("VId only struct") {
    using id_only_t = vertex_data<int, void, void>;
    REQUIRE(sizeof(id_only_t) == sizeof(int));
  }

  SECTION("Empty struct") {
    using empty_t = vertex_data<void, void, void>;
    // Empty struct has size 1 in C++ (must be distinct)
    REQUIRE(sizeof(empty_t) >= 1);
  }
}

TEST_CASE("vertex_data: copyable and movable", "[vertex_data]") {
  SECTION("Copy construction") {
    vertex_data<int, mock_vertex_descriptor, mock_value> vi1{1, mock_vertex_descriptor{1}, mock_value{42.0}};
    vertex_data<int, mock_vertex_descriptor, mock_value> vi2 = vi1;
  ...
  SECTION("Move construction") {
    vertex_data<int, mock_vertex_descriptor, mock_value> vi1{2, mock_vertex_descriptor{2}, mock_value{99.9}};
    vertex_data<int, mock_vertex_descriptor, mock_value> vi2 = std::move(vi1);
    REQUIRE(vi2.id == 2);
...
TEST_CASE("vertex_data: descriptor-based pattern primary use case", "[vertex_data]") {
  // This is the primary pattern for views: vertex_data<void, vertex_descriptor, VV>
  SECTION("Descriptor with value function") {
    vertex_data<void, mock_vertex_descriptor, int> vi{mock_vertex_descriptor{10}, 42};
  ...
  SECTION("Descriptor without value function") {
    vertex_data<void, mock_vertex_descriptor, void> vi{mock_vertex_descriptor{20}};
...
TEST_CASE("vertex_data: external data pattern use case", "[vertex_data]") {
  // This pattern is for external data: vertex_data<VId, void, VV>
  SECTION("ID and value for graph construction") {
    vertex_data<size_t, void, std::string> vi{42, std::string("vertex_data")};
  ...
  SECTION("ID only for lightweight iteration") {
    vertex_data<size_t, void, void> vi{123};
...
TEST_CASE("vertex_data: type traits are correct", "[vertex_data]") {
  SECTION("All type aliases match template parameters") {
    using vi_t = vertex_data<int, mock_vertex_descriptor, mock_value>;
  ...
  SECTION("Void type aliases when void") {
    using vi_t = vertex_data<void, void, mock_value>;
...
TEST_CASE("vertex_data: copyable_vertex_t alias works", "[vertex_data]") {
  SECTION("Alias matches specialized form") {
    using alias_t    = copyable_vertex_t<int, double>;
    using explicit_t = vertex_data<int, void, double>;
