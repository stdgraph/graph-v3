...
TEST_CASE("neighbor_info: all 16 specializations compile", "[neighbor_info]") {
    SECTION("VId, Sourced=true, V, VV all present") {
        neighbor_info<int, true, mock_vertex_descriptor, mock_value> ni{1, 2, mock_vertex_descriptor{10}, mock_value{42.0}};
    ...
    SECTION("VId, Sourced=true, V present; VV=void") {
        neighbor_info<int, true, mock_vertex_descriptor, void> ni{2, 3, mock_vertex_descriptor{20}};
    ...
    SECTION("VId, Sourced=true, VV present; V=void") {
        neighbor_info<int, true, void, mock_value> ni{3, 4, mock_value{99.9}};
    ...
    SECTION("VId, Sourced=true; V=void, VV=void") {
        neighbor_info<int, true, void, void> ni{4, 5};
    ...
    SECTION("VId, Sourced=false, V, VV all present") {
        neighbor_info<int, false, mock_vertex_descriptor, mock_value> ni{5, mock_vertex_descriptor{30}, mock_value{123.4}};
        REQUIRE(ni.target_id == 5);
    ...
    SECTION("VId, Sourced=false, V present; VV=void") {
        neighbor_info<int, false, mock_vertex_descriptor, void> ni{6, mock_vertex_descriptor{40}};
    ...
    SECTION("VId, Sourced=false, VV present; V=void") {
        neighbor_info<int, false, void, mock_value> ni{7, mock_value{77.7}};
    ...
    SECTION("VId, Sourced=false; V=void, VV=void") {
        neighbor_info<int, false, void, void> ni{8};
    ...
    SECTION("VId=void, Sourced=true; V, VV present (descriptor-based)") {
        neighbor_info<void, true, mock_vertex_descriptor, mock_value> ni{mock_vertex_descriptor{50}, mock_value{200.0}};
    ...
    SECTION("VId=void, Sourced=true, VV=void; V present") {
        neighbor_info<void, true, mock_vertex_descriptor, void> ni{mock_vertex_descriptor{60}};
    ...
    SECTION("VId=void, Sourced=true, V=void; VV present") {
        neighbor_info<void, true, void, mock_value> ni{mock_value{300.0}};
    ...
    SECTION("VId=void, Sourced=true; V=void, VV=void (empty)") {
        neighbor_info<void, true, void, void> ni{};
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::source_id_type>);
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::target_id_type>);
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::vertex_type>);
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::value_type>);
    ...
    SECTION("VId=void, Sourced=false; V, VV present (primary pattern)") {
        neighbor_info<void, false, mock_vertex_descriptor, mock_value> ni{mock_vertex_descriptor{70}, mock_value{400.0}};
    ...
    SECTION("VId=void, Sourced=false, VV=void; V present") {
        neighbor_info<void, false, mock_vertex_descriptor, void> ni{mock_vertex_descriptor{80}};
    ...
    SECTION("VId=void, Sourced=false, V=void; VV present") {
        neighbor_info<void, false, void, mock_value> ni{mock_value{500.0}};
    ...
    SECTION("VId=void, Sourced=false; V=void, VV=void (empty)") {
        neighbor_info<void, false, void, void> ni{};
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::source_id_type>);
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::target_id_type>);
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::vertex_type>);
        STATIC_REQUIRE(std::is_void_v<decltype(ni)::value_type>);
...
TEST_CASE("neighbor_info: structured bindings work correctly", "[neighbor_info]") {
...
TEST_CASE("neighbor_info: sizeof verifies physical absence of void members", "[neighbor_info]") {
    SECTION("Full struct vs VId=void reduces size") {
        using full_t = neighbor_info<int, true, mock_vertex_descriptor, mock_value>;
        using no_id_t = neighbor_info<void, true, mock_vertex_descriptor, mock_value>;
    ...
    SECTION("IDs only struct (Sourced=true)") {
        using ids_only_t = neighbor_info<int, true, void, void>;
        REQUIRE(sizeof(ids_only_t) == 2 * sizeof(int)); // source_id + target_id
    }

    SECTION("target_id only struct (Sourced=false)") {
        using id_only_t = neighbor_info<size_t, false, void, void>;
        REQUIRE(sizeof(id_only_t) == sizeof(size_t)); // Only target_id
    }

    SECTION("Empty structs") {
        using empty_sourced_t = neighbor_info<void, true, void, void>;
        using empty_unsourced_t = neighbor_info<void, false, void, void>;
...
TEST_CASE("neighbor_info: Sourced parameter affects member presence", "[neighbor_info]") {
    SECTION("Sourced=true has source_id and target_id") {
        neighbor_info<int, true, void, void> ni{42, 99};
    ...
    SECTION("Sourced=false has only target_id") {
        neighbor_info<int, false, void, void> ni{99};
        REQUIRE(ni.target_id == 99);
        STATIC_REQUIRE(std::is_same_v<decltype(ni.target_id), int>);
    }
}

TEST_CASE("neighbor_info: copyable and movable", "[neighbor_info]") {
    SECTION("Copy construction - Sourced=true") {
        neighbor_info<int, true, mock_vertex_descriptor, mock_value> ni1{1, 2, mock_vertex_descriptor{10}, mock_value{42.0}};
        neighbor_info<int, true, mock_vertex_descriptor, mock_value> ni2 = ni1;
    ...
    SECTION("Move construction - Sourced=false") {
        neighbor_info<int, false, mock_vertex_descriptor, mock_value> ni1{5, mock_vertex_descriptor{30}, mock_value{123.4}};
        neighbor_info<int, false, mock_vertex_descriptor, mock_value> ni2 = std::move(ni1);
...
TEST_CASE("neighbor_info: descriptor-based pattern primary use case", "[neighbor_info]") {
    SECTION("Primary pattern: neighbor_info<void, false, vertex_descriptor, VV>") {
        // This is THE primary pattern for neighbor views as per Section 8.3 of view_strategy
        neighbor_info<void, false, mock_vertex_descriptor, double> ni{mock_vertex_descriptor{100}, 3.14};
    ...
    SECTION("Descriptor without value function") {
        neighbor_info<void, false, mock_vertex_descriptor, void> ni{mock_vertex_descriptor{200}};
    ...
    SECTION("Sourced pattern: neighbor_info<void, true, vertex_descriptor, VV>") {
        // Used when iterating from known source
        neighbor_info<void, true, mock_vertex_descriptor, std::string> ni{
            mock_vertex_descriptor{300}, 
...
TEST_CASE("neighbor_info: external data pattern use case", "[neighbor_info]") {
    SECTION("Sourced external data: source_id, target_id and value") {
        neighbor_info<size_t, true, void, double> ni{100, 200, 12.34};
    ...
    SECTION("Unsourced external data: target_id and value") {
        neighbor_info<int, false, void, std::string> ni{42, std::string("data")};
    ...
    SECTION("ID with target descriptor (external construction)") {
        neighbor_info<size_t, false, mock_vertex_descriptor, void> ni{999, mock_vertex_descriptor{400}};
...
TEST_CASE("neighbor_info: type traits are correct", "[neighbor_info]") {
    SECTION("All type aliases match - Sourced=true") {
        using ni_t = neighbor_info<int, true, mock_vertex_descriptor, mock_value>;
    ...
    SECTION("All type aliases match - Sourced=false") {
        using ni_t = neighbor_info<size_t, false, mock_vertex_descriptor, mock_value>;
    ...
    SECTION("Void type aliases when void") {
        using ni_t = neighbor_info<void, true, void, mock_value>;
        STATIC_REQUIRE(std::is_void_v<ni_t::source_id_type>);
...
TEST_CASE("neighbor_info: copyable_neighbor_t alias works", "[neighbor_info]") {
    SECTION("copyable_neighbor_t alias (Sourced=true)") {
        using alias_t = copyable_neighbor_t<int, double>;
        using explicit_t = neighbor_info<int, true, void, double>;
...
TEST_CASE("neighbor_info: relationship to view_strategy.md Section 8.3", "[neighbor_info]") {
    SECTION("Section 8.3 specifies: neighbor_info<void, false, vertex_descriptor, VV>") {
        // Verify this is the exact pattern described in the strategy document
        using strategy_pattern = neighbor_info<void, false, mock_vertex_descriptor, double>;
    ...
    SECTION("Without value function: neighbor_info<void, false, vertex_descriptor, void>") {
        using no_value_pattern = neighbor_info<void, false, mock_vertex_descriptor, void>;
