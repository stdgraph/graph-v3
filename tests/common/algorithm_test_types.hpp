...
template <typename EV, typename VV, typename GV, typename VId, bool Sourced, bool Bidirectional, typename Traits>
struct is_sparse_vertex_container<container::dynamic_graph<EV, VV, GV, VId, Sourced, Bidirectional, Traits>>
      : std::bool_constant<std::same_as<Traits, container::mov_graph_traits<EV, VV, GV, VId, Sourced, Bidirectional>> ||
                           std::same_as<Traits, container::mod_graph_traits<EV, VV, GV, VId, Sourced, Bidirectional>> ||
                           std::same_as<Traits, container::mol_graph_traits<EV, VV, GV, VId, Sourced, Bidirectional>> ||
                           std::same_as<Traits, container::uov_graph_traits<EV, VV, GV, VId, Sourced, Bidirectional>> ||
                           std::same_as<Traits, container::uod_graph_traits<EV, VV, GV, VId, Sourced, Bidirectional>> ||
                           std::same_as<Traits, container::uol_graph_traits<EV, VV, GV, VId, Sourced, Bidirectional>>> {};
