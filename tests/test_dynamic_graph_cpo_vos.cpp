 ...
 * @brief Phase 4.1.2d CPO tests for dynamic_graph with vos_graph_traits
 * 
...
using vos_int_ev   = dynamic_graph<int, void, void, uint32_t, false, vos_graph_traits<int, void, void, uint32_t, false>>;
using vos_int_vv   = dynamic_graph<void, int, void, uint32_t, false, vos_graph_traits<void, int, void, uint32_t, false>>;
using vos_all_int  = dynamic_graph<int, int, int, uint32_t, false, vos_graph_traits<int, int, int, uint32_t, false>>;
using vos_string   = dynamic_graph<std::string, std::string, std::string, uint32_t, false, 
                                     vos_graph_traits<std::string, std::string, std::string, uint32_t, false>>;

// Type aliases for Sourced=true configurations (for source_id/source CPO tests)
using vos_sourced_void = dynamic_graph<void, void, void, uint32_t, true, vos_graph_traits<void, void, void, uint32_t, true>>;
using vos_sourced_int  = dynamic_graph<int, void, void, uint32_t, true, vos_graph_traits<int, void, void, uint32_t, true>>;
using vos_sourced_all  = dynamic_graph<int, int, int, uint32_t, true, vos_graph_traits<int, int, int, uint32_t, true>>;
...
TEST_CASE("vos CPO vertices(g)", "[dynamic_graph][vos][cpo][vertices]") {
...
TEST_CASE("vos CPO num_vertices(g)", "[dynamic_graph][vos][cpo][num_vertices]") {
    SECTION("empty graph") {
        vos_void g;
...
TEST_CASE("vos CPO find_vertex(g, uid)", "[dynamic_graph][vos][cpo][find_vertex]") {
...
TEST_CASE("vos CPO vertex_id(g, u)", "[dynamic_graph][vos][cpo][vertex_id]") {
...
TEST_CASE("vos CPO num_edges(g)", "[dynamic_graph][vos][cpo][num_edges]") {
    SECTION("empty graph") {
        vos_void g;
...
// NOTE: num_edges(g, u) and num_edges(g, uid) NOT supported with vos_graph_traits
...
TEST_CASE("vos CPO edges(g, u)", "[dynamic_graph][vos][cpo][edges]") {
...
TEST_CASE("vos CPO edges(g, uid)", "[dynamic_graph][vos][cpo][edges]") {
    SECTION("basic iteration") {
        vos_void g({{0, 1}, {0, 2}});
...
TEST_CASE("vos CPO degree(g, u)", "[dynamic_graph][vos][cpo][degree]") {
...
TEST_CASE("vos CPO target_id(g, uv)", "[dynamic_graph][vos][cpo][target_id]") {
    SECTION("basic access") {
        vos_void g({{0, 5}});
...
TEST_CASE("vos CPO target(g, uv)", "[dynamic_graph][vos][cpo][target]") {
    SECTION("basic access") {
        vos_void g({{0, 1}});
...
TEST_CASE("vos CPO find_vertex_edge(g, u, v)", "[dynamic_graph][vos][cpo][find_vertex_edge]") {
...
TEST_CASE("vos CPO find_vertex_edge(g, uid, vid)", "[dynamic_graph][vos][cpo][find_vertex_edge][uid_vid]") {
    SECTION("existing edge") {
        vos_void g({{0, 1}, {0, 2}});
...
TEST_CASE("vos CPO contains_edge(g, u, v)", "[dynamic_graph][vos][cpo][contains_edge]") {
    SECTION("existing edge") {
        vos_void g({{0, 1}, {1, 2}});
...
TEST_CASE("vos CPO contains_edge(g, uid, vid)", "[dynamic_graph][vos][cpo][contains_edge][uid_vid]") {
    SECTION("existing edge") {
        vos_void g({{0, 1}, {1, 2}});
...
TEST_CASE("vos CPO has_edge(g)", "[dynamic_graph][vos][cpo][has_edge]") {
    SECTION("empty graph") {
        vos_void g;
...
TEST_CASE("vos CPO vertex_value(g, u)", "[dynamic_graph][vos][cpo][vertex_value]") {
    SECTION("read access") {
        vos_int_vv g;
...
TEST_CASE("vos CPO edge_value(g, uv)", "[dynamic_graph][vos][cpo][edge_value]") {
    SECTION("read access") {
        vos_int_ev g;
        std::vector<edge_int> ee = {{0, 1, 100}, {0, 2, 200}};
        g.load_edges(ee, std::identity{});
...
TEST_CASE("vos CPO graph_value(g)", "[dynamic_graph][vos][cpo][graph_value]") {
    SECTION("read access") {
        vos_all_int g(42);
...
TEST_CASE("vos CPO partition_id(g, u)", "[dynamic_graph][vos][cpo][partition_id]") {
...
TEST_CASE("vos CPO num_partitions(g)", "[dynamic_graph][vos][cpo][num_partitions]") {
...
TEST_CASE("vos CPO vertices(g, pid)", "[dynamic_graph][vos][cpo][vertices][partition]") {
...
TEST_CASE("vos CPO num_vertices(g, pid)", "[dynamic_graph][vos][cpo][num_vertices][partition]") {
...
TEST_CASE("vos CPO source_id(g, uv)", "[dynamic_graph][vos][cpo][source_id]") {
    SECTION("basic access") {
...
TEST_CASE("vos CPO source(g, uv)", "[dynamic_graph][vos][cpo][source]") {
    SECTION("basic access") {
...
TEST_CASE("vos CPO integration", "[dynamic_graph][vos][cpo][integration]") {
...
TEST_CASE("vos CPO integration: modify vertex and edge values", "[dynamic_graph][vos][cpo][integration]") {
