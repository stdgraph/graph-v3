...
using mos_void_void_void = dynamic_graph<void, void, void, uint32_t, false, moem_graph_traits<void, void, void, uint32_t, false>>;
using mos_int_void_void = dynamic_graph<int, void, void, uint32_t, false, moem_graph_traits<int, void, void, uint32_t, false>>;
using mos_void_int_void = dynamic_graph<void, int, void, uint32_t, false, moem_graph_traits<void, int, void, uint32_t, false>>;
using mos_int_int_void = dynamic_graph<int, int, void, uint32_t, false, moem_graph_traits<int, int, void, uint32_t, false>>;
using mos_void_void_int = dynamic_graph<void, void, int, uint32_t, false, moem_graph_traits<void, void, int, uint32_t, false>>;
using mos_int_int_int = dynamic_graph<int, int, int, uint32_t, false, moem_graph_traits<int, int, int, uint32_t, false>>;

// Type aliases with string vertex IDs (the primary use case for map containers)
using mos_str_void_void_void = dynamic_graph<void, void, void, std::string, false, moem_graph_traits<void, void, void, std::string, false>>;
using mos_str_int_void_void = dynamic_graph<int, void, void, std::string, false, moem_graph_traits<int, void, void, std::string, false>>;
using mos_str_void_int_void = dynamic_graph<void, int, void, std::string, false, moem_graph_traits<void, int, void, std::string, false>>;
using mos_str_int_int_int = dynamic_graph<int, int, int, std::string, false, moem_graph_traits<int, int, int, std::string, false>>;

using mos_sourced = dynamic_graph<void, void, void, uint32_t, true, moem_graph_traits<void, void, void, uint32_t, true>>;
using mos_int_sourced = dynamic_graph<int, void, void, uint32_t, true, moem_graph_traits<int, void, void, uint32_t, true>>;

using mos_str_sourced = dynamic_graph<void, void, void, std::string, true, moem_graph_traits<void, void, void, std::string, true>>;
...
TEST_CASE("moem edge deduplication", "[dynamic_graph][moem][set][deduplication]") {
    ...
    SECTION("duplicate edges with different values - first value wins") {
        ...
        REQUIRE(it != g.end());
        REQUIRE(it->second.edges().begin()->second.value() == 100);
    }
...
TEST_CASE("moem edge bidirectional iteration", "[dynamic_graph][moem][set][iteration]") {
    ...
    SECTION("reverse iteration") {
        ...
        for (auto eit = edge_set.rbegin(); eit != edge_set.rend(); ++eit) {
            targets.push_back(eit->second.target_id());
        }
