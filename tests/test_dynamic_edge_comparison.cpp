...
using edge_ev_sourced = dynamic_edge<int, void, void, uint32_t, true, 
                                     vov_graph_traits<int, void, void, uint32_t, true>>;

// EV = void, Sourced = true
using edge_void_sourced = dynamic_edge<void, void, void, uint32_t, true,
                                       vov_graph_traits<void, void, void, uint32_t, true>>;

// EV != void, Sourced = false
using edge_ev_unsourced = dynamic_edge<int, void, void, uint32_t, false,
                                       vov_graph_traits<int, void, void, uint32_t, false>>;

// EV = void, Sourced = false
using edge_void_unsourced = dynamic_edge<void, void, void, uint32_t, false,
