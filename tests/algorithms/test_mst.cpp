...
struct simple_edge {
    ...
    constexpr simple_edge(VId s, VId t, EV v) 
        : source_id(s), target_id(t), value(v) {}
...
TEST_CASE("prim - complete graph K4", "[algorithm][mst][prim]") {
    ...
    // Complete graph on 4 vertices
    Graph g({{0,1,1}, {1,0,1}, {0,2,4}, {2,0,4}, {0,3,3}, {3,0,3},
             {1,2,2}, {2,1,2}, {1,3,5}, {3,1,5}, {2,3,6}, {3,2,6}});
...
TEST_CASE("kruskal and prim produce same MST weight", "[algorithm][mst]") {
    ...
    Graph g({{0,1,2}, {1,0,2}, {0,3,6}, {3,0,6},
             {1,2,3}, {2,1,3}, {1,3,8}, {3,1,8}, {1,4,5}, {4,1,5},
             {2,4,7}, {4,2,7},
             {3,4,9}, {4,3,9}});
