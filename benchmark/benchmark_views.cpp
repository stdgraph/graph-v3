...
BENCHMARK(BM_Vertexlist_Iteration)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
static void BM_Vertexlist_WithValueFunction(benchmark::State& state) {
    ...
    for (auto _ : state) {
        size_t sum = 0;
        for (auto [v, id] : g | vertexlist(vvf)) {
            benchmark::DoNotOptimize(v);
            sum += id;
        }
...
BENCHMARK(BM_Vertexlist_WithValueFunction)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
BENCHMARK(BM_Incidence_AllVertices)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
BENCHMARK(BM_Neighbors_AllVertices)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
BENCHMARK(BM_Edgelist_Iteration)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
BENCHMARK(BM_TopoSort_Vertices)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
BENCHMARK(BM_Chaining_Transform)
    ->RangeMultiplier(2)
    ->Range(100, 10000)
    ->Complexity();
...
static void BM_Chaining_Take(benchmark::State& state) {
    ...
    for (auto _ : state) {
        ...
        auto limited = g 
            | vertexlist()
            | std::views::take(100);  // Take first 100
